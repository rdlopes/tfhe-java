...
public class FheIntMapper extends AbstractFheTypeMapper {
  private static final Logger logger = LoggerFactory.getLogger(FheIntMapper.class);

  public FheIntMapper(FheTypeMapperContext context, String typeName) {
