...
public class FheInt72 extends AddressLayoutPointer implements Cloneable {

  protected FheInt72() {
    super(FheInt72.class, TfheWrapper::fhe_int72_destroy);
  }

  public static FheInt72 encryptWithClientKey(I128 clearValue, ClientKey clientKey) {
    FheInt72 fheint72 = new FheInt72();
    executeWithErrorHandling(() -> fhe_int72_try_encrypt_with_client_key_i128(clearValue.getAddress(), clientKey.getValue(), fheint72.getAddress()));
    return fheint72;
  }

  public static FheInt72 encryptWithPublicKey(I128 clearValue, PublicKey publicKey) {
    FheInt72 fheint72 = new FheInt72();
    executeWithErrorHandling(() -> fhe_int72_try_encrypt_with_public_key_i128(clearValue.getAddress(), publicKey.getValue(), fheint72.getAddress()));
    return fheint72;
  }

  public static FheInt72 encryptTrivial(I128 clearValue) {
    FheInt72 fheint72 = new FheInt72();
    executeWithErrorHandling(() -> fhe_int72_try_encrypt_trivial_i128(clearValue.getAddress(), fheint72.getAddress()));
    return fheint72;
  }

  public static FheInt72 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt72 fheint72 = new FheInt72();
    executeWithErrorHandling(() -> fhe_int72_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint72.getAddress()));
    return fheint72;
  }
  ...
  public FheInt72 clone() {
    FheInt72 fheint72 = new FheInt72();
    executeWithErrorHandling(() -> fhe_int72_clone(getValue(), fheint72.getAddress()));
    return fheint72;
  }
}
