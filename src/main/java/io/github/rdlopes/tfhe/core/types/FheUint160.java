...
public class FheUint160 extends AddressLayoutPointer implements
  ...
  public static FheUint160
  encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint160 fhe = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint160 fhe = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint160 encryptTrivial(U256 clearValue) {
    FheUint160 fhe = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_try_encrypt_trivial_u256(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint160 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint160 fhe = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheUint160 scalarAnd(U256 scalar) {
    FheUint160 result = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint160_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheUint160 scalarOr(U256 scalar) {
    FheUint160 result = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint160_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheUint160 scalarXor(U256 scalar) {
    FheUint160 result = new FheUint160();
    executeWithErrorHandling(() -> fhe_uint160_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint160_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheUint160 clone() {
    ...
    executeWithErrorHandling(() -> fhe_uint160_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
