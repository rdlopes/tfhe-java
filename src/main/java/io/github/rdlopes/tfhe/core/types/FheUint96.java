...
public class FheUint96 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint96 encryptWithClientKey(U128 clearValue, ClientKey clientKey) {
    FheUint96 fheuint96 = new FheUint96();
    executeWithErrorHandling(() -> fhe_uint96_try_encrypt_with_client_key_u128(clearValue.getAddress(), clientKey.getValue(), fheuint96.getAddress()));
    return fheuint96;
  }

  public static FheUint96 encryptWithPublicKey(U128 clearValue, PublicKey publicKey) {
    FheUint96 fheuint96 = new FheUint96();
    executeWithErrorHandling(() -> fhe_uint96_try_encrypt_with_public_key_u128(clearValue.getAddress(), publicKey.getValue(), fheuint96.getAddress()));
    return fheuint96;
  }

  public static FheUint96 encryptTrivial(U128 clearValue) {
    FheUint96 fheuint96 = new FheUint96();
    executeWithErrorHandling(() -> fhe_uint96_try_encrypt_trivial_u128(clearValue.getAddress(), fheuint96.getAddress()));
    return fheuint96;
  }

  public static FheUint96 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint96 fheuint96 = new FheUint96();
    executeWithErrorHandling(() -> fhe_uint96_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint96.getAddress()));
    return fheuint96;
  }
  ...
  public FheUint96 clone() {
    FheUint96 fheuint96 = new FheUint96();
    executeWithErrorHandling(() -> fhe_uint96_clone(getValue(), fheuint96.getAddress()));
    return fheuint96;
  }
}
