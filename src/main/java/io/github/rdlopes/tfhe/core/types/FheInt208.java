...
public class FheInt208 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheInt208 encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt208 fheint208 = new FheInt208();
    executeWithErrorHandling(() -> fhe_int208_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fheint208.getAddress()));
    return fheint208;
  }

  public static FheInt208 encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt208 fheint208 = new FheInt208();
    executeWithErrorHandling(() -> fhe_int208_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fheint208.getAddress()));
    return fheint208;
  }

  public static FheInt208 encryptTrivial(I256 clearValue) {
    FheInt208 fheint208 = new FheInt208();
    executeWithErrorHandling(() -> fhe_int208_try_encrypt_trivial_i256(clearValue.getAddress(), fheint208.getAddress()));
    return fheint208;
  }

  public static FheInt208 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt208 fheint208 = new FheInt208();
    executeWithErrorHandling(() -> fhe_int208_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint208.getAddress()));
    return fheint208;
  }
  ...
  public FheInt208 clone() {
    FheInt208 fheint208 = new FheInt208();
    executeWithErrorHandling(() -> fhe_int208_clone(getValue(), fheint208.getAddress()));
    return fheint208;
  }
}
