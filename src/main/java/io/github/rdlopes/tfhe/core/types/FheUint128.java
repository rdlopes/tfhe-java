...
public class FheUint128 extends AddressLayoutPointer implements Cloneable {

  protected FheUint128() {
    super(FheUint128.class, TfheWrapper::fhe_uint128_destroy);
  }

  public static FheUint128 encryptWithClientKey(U128 clearValue, ClientKey clientKey) {
    FheUint128 fheuint128 = new FheUint128();
    executeWithErrorHandling(() -> fhe_uint128_try_encrypt_with_client_key_u128(clearValue.getAddress(), clientKey.getValue(), fheuint128.getAddress()));
    return fheuint128;
  }

  public static FheUint128 encryptWithPublicKey(U128 clearValue, PublicKey publicKey) {
    FheUint128 fheuint128 = new FheUint128();
    executeWithErrorHandling(() -> fhe_uint128_try_encrypt_with_public_key_u128(clearValue.getAddress(), publicKey.getValue(), fheuint128.getAddress()));
    return fheuint128;
  }

  public static FheUint128 encryptTrivial(U128 clearValue) {
    FheUint128 fheuint128 = new FheUint128();
    executeWithErrorHandling(() -> fhe_uint128_try_encrypt_trivial_u128(clearValue.getAddress(), fheuint128.getAddress()));
    return fheuint128;
  }

  public static FheUint128 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint128 fheuint128 = new FheUint128();
    executeWithErrorHandling(() -> fhe_uint128_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint128.getAddress()));
    return fheuint128;
  }
  ...
  public FheUint128 clone() {
    FheUint128 fheuint128 = new FheUint128();
    executeWithErrorHandling(() -> fhe_uint128_clone(getValue(), fheuint128.getAddress()));
    return fheuint128;
  }
}
