...
public class FheUint88 extends AddressLayoutPointer implements Cloneable {

  protected FheUint88() {
    super(FheUint88.class, TfheWrapper::fhe_uint88_destroy);
  }

  public static FheUint88 encryptWithClientKey(U128 clearValue, ClientKey clientKey) {
    FheUint88 fheuint88 = new FheUint88();
    executeWithErrorHandling(() -> fhe_uint88_try_encrypt_with_client_key_u128(clearValue.getAddress(), clientKey.getValue(), fheuint88.getAddress()));
    return fheuint88;
  }

  public static FheUint88 encryptWithPublicKey(U128 clearValue, PublicKey publicKey) {
    FheUint88 fheuint88 = new FheUint88();
    executeWithErrorHandling(() -> fhe_uint88_try_encrypt_with_public_key_u128(clearValue.getAddress(), publicKey.getValue(), fheuint88.getAddress()));
    return fheuint88;
  }

  public static FheUint88 encryptTrivial(U128 clearValue) {
    FheUint88 fheuint88 = new FheUint88();
    executeWithErrorHandling(() -> fhe_uint88_try_encrypt_trivial_u128(clearValue.getAddress(), fheuint88.getAddress()));
    return fheuint88;
  }

  public static FheUint88 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint88 fheuint88 = new FheUint88();
    executeWithErrorHandling(() -> fhe_uint88_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint88.getAddress()));
    return fheuint88;
  }
  ...
  public FheUint88 clone() {
    FheUint88 fheuint88 = new FheUint88();
    executeWithErrorHandling(() -> fhe_uint88_clone(getValue(), fheuint88.getAddress()));
    return fheuint88;
  }
}
