...
public class FheUint232 extends AddressLayoutPointer implements Cloneable {

  protected FheUint232() {
    super(FheUint232.class, TfheWrapper::fhe_uint232_destroy);
  }

  public static FheUint232 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint232 fheuint232 = new FheUint232();
    executeWithErrorHandling(() -> fhe_uint232_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint232.getAddress()));
    return fheuint232;
  }

  public static FheUint232 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint232 fheuint232 = new FheUint232();
    executeWithErrorHandling(() -> fhe_uint232_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint232.getAddress()));
    return fheuint232;
  }

  public static FheUint232 encryptTrivial(U256 clearValue) {
    FheUint232 fheuint232 = new FheUint232();
    executeWithErrorHandling(() -> fhe_uint232_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint232.getAddress()));
    return fheuint232;
  }

  public static FheUint232 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint232 fheuint232 = new FheUint232();
    executeWithErrorHandling(() -> fhe_uint232_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint232.getAddress()));
    return fheuint232;
  }
  ...
  public FheUint232 clone() {
    FheUint232 fheuint232 = new FheUint232();
    executeWithErrorHandling(() -> fhe_uint232_clone(getValue(), fheuint232.getAddress()));
    return fheuint232;
  }
}
