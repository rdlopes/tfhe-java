...
public class FheUint192 extends AddressLayoutPointer implements
  ...
  public static FheUint192
  encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint192 fhe = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint192 fhe = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint192 encryptTrivial(U256 clearValue) {
    FheUint192 fhe = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_try_encrypt_trivial_u256(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint192 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint192 fhe = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheUint192 scalarAnd(U256 scalar) {
    FheUint192 result = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint192_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheUint192 scalarOr(U256 scalar) {
    FheUint192 result = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint192_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheUint192 scalarXor(U256 scalar) {
    FheUint192 result = new FheUint192();
    executeWithErrorHandling(() -> fhe_uint192_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint192_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheUint192 clone() {
    ...
    executeWithErrorHandling(() -> fhe_uint192_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
