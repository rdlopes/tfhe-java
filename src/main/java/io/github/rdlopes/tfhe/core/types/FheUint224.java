...
public class FheUint224 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint224 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint224 fheuint224 = new FheUint224();
    executeWithErrorHandling(() -> fhe_uint224_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint224.getAddress()));
    return fheuint224;
  }

  public static FheUint224 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint224 fheuint224 = new FheUint224();
    executeWithErrorHandling(() -> fhe_uint224_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint224.getAddress()));
    return fheuint224;
  }

  public static FheUint224 encryptTrivial(U256 clearValue) {
    FheUint224 fheuint224 = new FheUint224();
    executeWithErrorHandling(() -> fhe_uint224_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint224.getAddress()));
    return fheuint224;
  }

  public static FheUint224 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint224 fheuint224 = new FheUint224();
    executeWithErrorHandling(() -> fhe_uint224_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint224.getAddress()));
    return fheuint224;
  }
  ...
  public FheUint224 clone() {
    FheUint224 fheuint224 = new FheUint224();
    executeWithErrorHandling(() -> fhe_uint224_clone(getValue(), fheuint224.getAddress()));
    return fheuint224;
  }
}
