...
public class FheInt224 extends AddressLayoutPointer implements
  ...
  public static FheInt224
  encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt224 fhe = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt224 fhe = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt224 encryptTrivial(I256 clearValue) {
    FheInt224 fhe = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_try_encrypt_trivial_i256(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt224 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt224 fhe = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheInt224 scalarAnd(I256 scalar) {
    FheInt224 result = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(I256 scalar) {
    executeWithErrorHandling(() -> fhe_int224_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheInt224 scalarOr(I256 scalar) {
    FheInt224 result = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(I256 scalar) {
    executeWithErrorHandling(() -> fhe_int224_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheInt224 scalarXor(I256 scalar) {
    FheInt224 result = new FheInt224();
    executeWithErrorHandling(() -> fhe_int224_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(I256 scalar) {
    executeWithErrorHandling(() -> fhe_int224_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheInt224 clone() {
    ...
    executeWithErrorHandling(() -> fhe_int224_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
