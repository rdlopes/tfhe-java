...
public class FheInt88 extends AddressLayoutPointer implements Cloneable {

  protected FheInt88() {
    super(FheInt88.class, TfheWrapper::fhe_int88_destroy);
  }

  public static FheInt88 encryptWithClientKey(I128 clearValue, ClientKey clientKey) {
    FheInt88 fheint88 = new FheInt88();
    executeWithErrorHandling(() -> fhe_int88_try_encrypt_with_client_key_i128(clearValue.getAddress(), clientKey.getValue(), fheint88.getAddress()));
    return fheint88;
  }

  public static FheInt88 encryptWithPublicKey(I128 clearValue, PublicKey publicKey) {
    FheInt88 fheint88 = new FheInt88();
    executeWithErrorHandling(() -> fhe_int88_try_encrypt_with_public_key_i128(clearValue.getAddress(), publicKey.getValue(), fheint88.getAddress()));
    return fheint88;
  }

  public static FheInt88 encryptTrivial(I128 clearValue) {
    FheInt88 fheint88 = new FheInt88();
    executeWithErrorHandling(() -> fhe_int88_try_encrypt_trivial_i128(clearValue.getAddress(), fheint88.getAddress()));
    return fheint88;
  }

  public static FheInt88 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt88 fheint88 = new FheInt88();
    executeWithErrorHandling(() -> fhe_int88_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint88.getAddress()));
    return fheint88;
  }
  ...
  public FheInt88 clone() {
    FheInt88 fheint88 = new FheInt88();
    executeWithErrorHandling(() -> fhe_int88_clone(getValue(), fheint88.getAddress()));
    return fheint88;
  }
}
