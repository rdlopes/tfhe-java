...
public class FheUint8 extends AddressLayoutPointer implements
  ...
  public static FheUint8
  encryptWithClientKey(byte clearValue, ClientKey clientKey) {
    FheUint8 fhe = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_try_encrypt_with_client_key_u8(clearValue, clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(byte clearValue, PublicKey publicKey) {
    FheUint8 fhe = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_try_encrypt_with_public_key_u8(clearValue, publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint8 encryptTrivial(byte clearValue) {
    FheUint8 fhe = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_try_encrypt_trivial_u8(clearValue, fhe.getAddress()));
    return fhe;
  }

  public static FheUint8 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint8 fhe = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheUint8 scalarAnd(byte scalar) {
    FheUint8 result = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_scalar_bitand(getValue(), scalar, result.getAddress()));
    return result;
  }

  public void scalarAndAssign(byte scalar) {
    executeWithErrorHandling(() -> fhe_uint8_scalar_bitand_assign(getValue(), scalar));
  }

  public FheUint8 scalarOr(byte scalar) {
    FheUint8 result = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_scalar_bitor(getValue(), scalar, result.getAddress()));
    return result;
  }

  public void scalarOrAssign(byte scalar) {
    executeWithErrorHandling(() -> fhe_uint8_scalar_bitor_assign(getValue(), scalar));
  }

  public FheUint8 scalarXor(byte scalar) {
    FheUint8 result = new FheUint8();
    executeWithErrorHandling(() -> fhe_uint8_scalar_bitxor(getValue(), scalar, result.getAddress()));
    return result;
  }

  public void scalarXorAssign(byte scalar) {
    executeWithErrorHandling(() -> fhe_uint8_scalar_bitxor_assign(getValue(), scalar));
  }
  ...
  public FheUint8 clone() {
    ...
    executeWithErrorHandling(() -> fhe_uint8_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
