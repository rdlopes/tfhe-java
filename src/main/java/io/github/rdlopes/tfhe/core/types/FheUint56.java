...
public class FheUint56 extends AddressLayoutPointer implements Cloneable {

  protected FheUint56() {
    super(FheUint56.class, TfheWrapper::fhe_uint56_destroy);
  }

  public static FheUint56 encryptWithClientKey(long clearValue, ClientKey clientKey) {
    FheUint56 fheuint56 = new FheUint56();
    executeWithErrorHandling(() -> fhe_uint56_try_encrypt_with_client_key_u64(clearValue, clientKey.getValue(), fheuint56.getAddress()));
    return fheuint56;
  }

  public static FheUint56 encryptWithPublicKey(long clearValue, PublicKey publicKey) {
    FheUint56 fheuint56 = new FheUint56();
    executeWithErrorHandling(() -> fhe_uint56_try_encrypt_with_public_key_u64(clearValue, publicKey.getValue(), fheuint56.getAddress()));
    return fheuint56;
  }

  public static FheUint56 encryptTrivial(long clearValue) {
    FheUint56 fheuint56 = new FheUint56();
    executeWithErrorHandling(() -> fhe_uint56_try_encrypt_trivial_u64(clearValue, fheuint56.getAddress()));
    return fheuint56;
  }

  public static FheUint56 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint56 fheuint56 = new FheUint56();
    executeWithErrorHandling(() -> fhe_uint56_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint56.getAddress()));
    return fheuint56;
  }
  ...
  public FheUint56 clone() {
    FheUint56 fheuint56 = new FheUint56();
    executeWithErrorHandling(() -> fhe_uint56_clone(getValue(), fheuint56.getAddress()));
    return fheuint56;
  }
}
