...
public class FheUint256 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint256 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint256 fheuint256 = new FheUint256();
    executeWithErrorHandling(() -> fhe_uint256_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint256.getAddress()));
    return fheuint256;
  }

  public static FheUint256 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint256 fheuint256 = new FheUint256();
    executeWithErrorHandling(() -> fhe_uint256_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint256.getAddress()));
    return fheuint256;
  }

  public static FheUint256 encryptTrivial(U256 clearValue) {
    FheUint256 fheuint256 = new FheUint256();
    executeWithErrorHandling(() -> fhe_uint256_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint256.getAddress()));
    return fheuint256;
  }

  public static FheUint256 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint256 fheuint256 = new FheUint256();
    executeWithErrorHandling(() -> fhe_uint256_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint256.getAddress()));
    return fheuint256;
  }
  ...
  public FheUint256 clone() {
    FheUint256 fheuint256 = new FheUint256();
    executeWithErrorHandling(() -> fhe_uint256_clone(getValue(), fheuint256.getAddress()));
    return fheuint256;
  }
}
