...
public class FheInt64 extends AddressLayoutPointer implements
  ...
  public static FheInt64
  encryptWithClientKey(long clearValue, ClientKey clientKey) {
    FheInt64 fhe = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_try_encrypt_with_client_key_i64(clearValue, clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(long clearValue, PublicKey publicKey) {
    FheInt64 fhe = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_try_encrypt_with_public_key_i64(clearValue, publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt64 encryptTrivial(long clearValue) {
    FheInt64 fhe = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_try_encrypt_trivial_i64(clearValue, fhe.getAddress()));
    return fhe;
  }

  public static FheInt64 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt64 fhe = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheInt64 scalarAnd(long scalar) {
    FheInt64 result = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_scalar_bitand(getValue(), scalar, result.getAddress()));
    return result;
  }

  public void scalarAndAssign(long scalar) {
    executeWithErrorHandling(() -> fhe_int64_scalar_bitand_assign(getValue(), scalar));
  }

  public FheInt64 scalarOr(long scalar) {
    FheInt64 result = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_scalar_bitor(getValue(), scalar, result.getAddress()));
    return result;
  }

  public void scalarOrAssign(long scalar) {
    executeWithErrorHandling(() -> fhe_int64_scalar_bitor_assign(getValue(), scalar));
  }

  public FheInt64 scalarXor(long scalar) {
    FheInt64 result = new FheInt64();
    executeWithErrorHandling(() -> fhe_int64_scalar_bitxor(getValue(), scalar, result.getAddress()));
    return result;
  }

  public void scalarXorAssign(long scalar) {
    executeWithErrorHandling(() -> fhe_int64_scalar_bitxor_assign(getValue(), scalar));
  }
  ...
  public FheInt64 clone() {
    ...
    executeWithErrorHandling(() -> fhe_int64_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
