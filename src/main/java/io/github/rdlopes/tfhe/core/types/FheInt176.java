...
public class FheInt176 extends AddressLayoutPointer implements Cloneable {

  protected FheInt176() {
    super(FheInt176.class, TfheWrapper::fhe_int176_destroy);
  }

  public static FheInt176 encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt176 fheint176 = new FheInt176();
    executeWithErrorHandling(() -> fhe_int176_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fheint176.getAddress()));
    return fheint176;
  }

  public static FheInt176 encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt176 fheint176 = new FheInt176();
    executeWithErrorHandling(() -> fhe_int176_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fheint176.getAddress()));
    return fheint176;
  }

  public static FheInt176 encryptTrivial(I256 clearValue) {
    FheInt176 fheint176 = new FheInt176();
    executeWithErrorHandling(() -> fhe_int176_try_encrypt_trivial_i256(clearValue.getAddress(), fheint176.getAddress()));
    return fheint176;
  }

  public static FheInt176 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt176 fheint176 = new FheInt176();
    executeWithErrorHandling(() -> fhe_int176_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint176.getAddress()));
    return fheint176;
  }
  ...
  public FheInt176 clone() {
    FheInt176 fheint176 = new FheInt176();
    executeWithErrorHandling(() -> fhe_int176_clone(getValue(), fheint176.getAddress()));
    return fheint176;
  }
}
