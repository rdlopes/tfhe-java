...
public class FheUint248 extends AddressLayoutPointer implements Cloneable {

  protected FheUint248() {
    super(FheUint248.class, TfheWrapper::fhe_uint248_destroy);
  }

  public static FheUint248 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint248 fheuint248 = new FheUint248();
    executeWithErrorHandling(() -> fhe_uint248_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint248.getAddress()));
    return fheuint248;
  }

  public static FheUint248 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint248 fheuint248 = new FheUint248();
    executeWithErrorHandling(() -> fhe_uint248_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint248.getAddress()));
    return fheuint248;
  }

  public static FheUint248 encryptTrivial(U256 clearValue) {
    FheUint248 fheuint248 = new FheUint248();
    executeWithErrorHandling(() -> fhe_uint248_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint248.getAddress()));
    return fheuint248;
  }

  public static FheUint248 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint248 fheuint248 = new FheUint248();
    executeWithErrorHandling(() -> fhe_uint248_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint248.getAddress()));
    return fheuint248;
  }
  ...
  public FheUint248 clone() {
    FheUint248 fheuint248 = new FheUint248();
    executeWithErrorHandling(() -> fhe_uint248_clone(getValue(), fheuint248.getAddress()));
    return fheuint248;
  }
}
