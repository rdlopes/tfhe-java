...
public class FheUint80 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint80 encryptWithClientKey(U128 clearValue, ClientKey clientKey) {
    FheUint80 fheuint80 = new FheUint80();
    executeWithErrorHandling(() -> fhe_uint80_try_encrypt_with_client_key_u128(clearValue.getAddress(), clientKey.getValue(), fheuint80.getAddress()));
    return fheuint80;
  }

  public static FheUint80 encryptWithPublicKey(U128 clearValue, PublicKey publicKey) {
    FheUint80 fheuint80 = new FheUint80();
    executeWithErrorHandling(() -> fhe_uint80_try_encrypt_with_public_key_u128(clearValue.getAddress(), publicKey.getValue(), fheuint80.getAddress()));
    return fheuint80;
  }

  public static FheUint80 encryptTrivial(U128 clearValue) {
    FheUint80 fheuint80 = new FheUint80();
    executeWithErrorHandling(() -> fhe_uint80_try_encrypt_trivial_u128(clearValue.getAddress(), fheuint80.getAddress()));
    return fheuint80;
  }

  public static FheUint80 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint80 fheuint80 = new FheUint80();
    executeWithErrorHandling(() -> fhe_uint80_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint80.getAddress()));
    return fheuint80;
  }
  ...
  public FheUint80 clone() {
    FheUint80 fheuint80 = new FheUint80();
    executeWithErrorHandling(() -> fhe_uint80_clone(getValue(), fheuint80.getAddress()));
    return fheuint80;
  }
}
