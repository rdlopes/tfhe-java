...
public class FheInt2048 extends AddressLayoutPointer implements
  ...
  public static FheInt2048
  encryptWithClientKey(I2048 clearValue, ClientKey clientKey) {
    FheInt2048 fhe = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_try_encrypt_with_client_key_i2048(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt2048
  encryptWithPublicKey(I2048 clearValue, PublicKey publicKey) {
    FheInt2048 fhe = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_try_encrypt_with_public_key_i2048(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt2048 encryptTrivial(I2048 clearValue) {
    FheInt2048 fhe = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_try_encrypt_trivial_i2048(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt2048 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt2048 fhe = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  decryptWithClientKey(ClientKey clientKey) {
    I2048 clearValue = new I2048();
    executeWithErrorHandling(() -> fhe_int2048_decrypt(getValue(), clientKey.getValue(), clearValue.getAddress()));
    return clearValue;
  }

  public I2048 decryptTrivial() {
    I2048 clearValue = new I2048();
    executeWithErrorHandling(() -> fhe_int2048_try_decrypt_trivial(getValue(), clearValue.getAddress()));
    return clearValue;
  }
  ...
  public FheInt2048 scalarAnd(I2048 scalar) {
    FheInt2048 result = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(I2048 scalar) {
    executeWithErrorHandling(() -> fhe_int2048_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheInt2048 scalarOr(I2048 scalar) {
    FheInt2048 result = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(I2048 scalar) {
    executeWithErrorHandling(() -> fhe_int2048_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheInt2048 scalarXor(I2048 scalar) {
    FheInt2048 result = new FheInt2048();
    executeWithErrorHandling(() -> fhe_int2048_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(I2048 scalar) {
    executeWithErrorHandling(() -> fhe_int2048_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheInt2048 clone() {
    ...
    executeWithErrorHandling(() -> fhe_int2048_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
