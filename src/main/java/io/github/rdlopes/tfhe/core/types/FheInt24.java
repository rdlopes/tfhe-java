...
public class FheInt24 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheInt24 encryptWithClientKey(int clearValue, ClientKey clientKey) {
    FheInt24 fheint24 = new FheInt24();
    executeWithErrorHandling(() -> fhe_int24_try_encrypt_with_client_key_i32(clearValue, clientKey.getValue(), fheint24.getAddress()));
    return fheint24;
  }

  public static FheInt24 encryptWithPublicKey(int clearValue, PublicKey publicKey) {
    FheInt24 fheint24 = new FheInt24();
    executeWithErrorHandling(() -> fhe_int24_try_encrypt_with_public_key_i32(clearValue, publicKey.getValue(), fheint24.getAddress()));
    return fheint24;
  }

  public static FheInt24 encryptTrivial(int clearValue) {
    FheInt24 fheint24 = new FheInt24();
    executeWithErrorHandling(() -> fhe_int24_try_encrypt_trivial_i32(clearValue, fheint24.getAddress()));
    return fheint24;
  }

  public static FheInt24 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt24 fheint24 = new FheInt24();
    executeWithErrorHandling(() -> fhe_int24_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint24.getAddress()));
    return fheint24;
  }
  ...
  public FheInt24 clone() {
    FheInt24 fheint24 = new FheInt24();
    executeWithErrorHandling(() -> fhe_int24_clone(getValue(), fheint24.getAddress()));
    return fheint24;
  }
}
