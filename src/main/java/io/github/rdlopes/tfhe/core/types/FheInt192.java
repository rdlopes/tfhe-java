...
public class FheInt192 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheInt192 encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt192 fheint192 = new FheInt192();
    executeWithErrorHandling(() -> fhe_int192_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fheint192.getAddress()));
    return fheint192;
  }

  public static FheInt192 encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt192 fheint192 = new FheInt192();
    executeWithErrorHandling(() -> fhe_int192_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fheint192.getAddress()));
    return fheint192;
  }

  public static FheInt192 encryptTrivial(I256 clearValue) {
    FheInt192 fheint192 = new FheInt192();
    executeWithErrorHandling(() -> fhe_int192_try_encrypt_trivial_i256(clearValue.getAddress(), fheint192.getAddress()));
    return fheint192;
  }

  public static FheInt192 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt192 fheint192 = new FheInt192();
    executeWithErrorHandling(() -> fhe_int192_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint192.getAddress()));
    return fheint192;
  }
  ...
  public FheInt192 clone() {
    FheInt192 fheint192 = new FheInt192();
    executeWithErrorHandling(() -> fhe_int192_clone(getValue(), fheint192.getAddress()));
    return fheint192;
  }
}
