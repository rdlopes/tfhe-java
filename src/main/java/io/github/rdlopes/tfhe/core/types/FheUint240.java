...
public class FheUint240 extends AddressLayoutPointer implements Cloneable {

  protected FheUint240() {
    super(FheUint240.class, TfheWrapper::fhe_uint240_destroy);
  }

  public static FheUint240 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint240 fheuint240 = new FheUint240();
    executeWithErrorHandling(() -> fhe_uint240_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint240.getAddress()));
    return fheuint240;
  }

  public static FheUint240 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint240 fheuint240 = new FheUint240();
    executeWithErrorHandling(() -> fhe_uint240_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint240.getAddress()));
    return fheuint240;
  }

  public static FheUint240 encryptTrivial(U256 clearValue) {
    FheUint240 fheuint240 = new FheUint240();
    executeWithErrorHandling(() -> fhe_uint240_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint240.getAddress()));
    return fheuint240;
  }

  public static FheUint240 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint240 fheuint240 = new FheUint240();
    executeWithErrorHandling(() -> fhe_uint240_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint240.getAddress()));
    return fheuint240;
  }
  ...
  public FheUint240 clone() {
    FheUint240 fheuint240 = new FheUint240();
    executeWithErrorHandling(() -> fhe_uint240_clone(getValue(), fheuint240.getAddress()));
    return fheuint240;
  }
}
