...
public class FheUint1024 extends AddressLayoutPointer implements
  ...
  public static FheUint1024
  encryptWithClientKey(U1024 clearValue, ClientKey clientKey) {
    FheUint1024 fhe = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_try_encrypt_with_client_key_u1024(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint1024
  encryptWithPublicKey(U1024 clearValue, PublicKey publicKey) {
    FheUint1024 fhe = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_try_encrypt_with_public_key_u1024(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint1024 encryptTrivial(U1024 clearValue) {
    FheUint1024 fhe = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_try_encrypt_trivial_u1024(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint1024 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint1024 fhe = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheUint1024 scalarAnd(U1024 scalar) {
    FheUint1024 result = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(U1024 scalar) {
    executeWithErrorHandling(() -> fhe_uint1024_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheUint1024 scalarOr(U1024 scalar) {
    FheUint1024 result = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(U1024 scalar) {
    executeWithErrorHandling(() -> fhe_uint1024_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheUint1024 scalarXor(U1024 scalar) {
    FheUint1024 result = new FheUint1024();
    executeWithErrorHandling(() -> fhe_uint1024_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(U1024 scalar) {
    executeWithErrorHandling(() -> fhe_uint1024_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheUint1024 clone() {
    ...
    executeWithErrorHandling(() -> fhe_uint1024_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
