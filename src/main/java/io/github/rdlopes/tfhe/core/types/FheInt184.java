...
public class FheInt184 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheInt184 encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt184 fheint184 = new FheInt184();
    executeWithErrorHandling(() -> fhe_int184_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fheint184.getAddress()));
    return fheint184;
  }

  public static FheInt184 encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt184 fheint184 = new FheInt184();
    executeWithErrorHandling(() -> fhe_int184_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fheint184.getAddress()));
    return fheint184;
  }

  public static FheInt184 encryptTrivial(I256 clearValue) {
    FheInt184 fheint184 = new FheInt184();
    executeWithErrorHandling(() -> fhe_int184_try_encrypt_trivial_i256(clearValue.getAddress(), fheint184.getAddress()));
    return fheint184;
  }

  public static FheInt184 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt184 fheint184 = new FheInt184();
    executeWithErrorHandling(() -> fhe_int184_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint184.getAddress()));
    return fheint184;
  }
  ...
  public FheInt184 clone() {
    FheInt184 fheint184 = new FheInt184();
    executeWithErrorHandling(() -> fhe_int184_clone(getValue(), fheint184.getAddress()));
    return fheint184;
  }
}
