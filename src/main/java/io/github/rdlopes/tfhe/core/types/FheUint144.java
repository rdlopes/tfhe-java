...
public class FheUint144 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint144 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint144 fheuint144 = new FheUint144();
    executeWithErrorHandling(() -> fhe_uint144_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint144.getAddress()));
    return fheuint144;
  }

  public static FheUint144 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint144 fheuint144 = new FheUint144();
    executeWithErrorHandling(() -> fhe_uint144_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint144.getAddress()));
    return fheuint144;
  }

  public static FheUint144 encryptTrivial(U256 clearValue) {
    FheUint144 fheuint144 = new FheUint144();
    executeWithErrorHandling(() -> fhe_uint144_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint144.getAddress()));
    return fheuint144;
  }

  public static FheUint144 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint144 fheuint144 = new FheUint144();
    executeWithErrorHandling(() -> fhe_uint144_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint144.getAddress()));
    return fheuint144;
  }
  ...
  public FheUint144 clone() {
    FheUint144 fheuint144 = new FheUint144();
    executeWithErrorHandling(() -> fhe_uint144_clone(getValue(), fheuint144.getAddress()));
    return fheuint144;
  }
}
