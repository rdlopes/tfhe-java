...
public class FheInt16 extends AddressLayoutPointer implements Cloneable {

  protected FheInt16() {
    super(FheInt16.class, TfheWrapper::fhe_int16_destroy);
  }

  public static FheInt16 encryptWithClientKey(short clearValue, ClientKey clientKey) {
    FheInt16 fheint16 = new FheInt16();
    executeWithErrorHandling(() -> fhe_int16_try_encrypt_with_client_key_i16(clearValue, clientKey.getValue(), fheint16.getAddress()));
    return fheint16;
  }

  public static FheInt16 encryptWithPublicKey(short clearValue, PublicKey publicKey) {
    FheInt16 fheint16 = new FheInt16();
    executeWithErrorHandling(() -> fhe_int16_try_encrypt_with_public_key_i16(clearValue, publicKey.getValue(), fheint16.getAddress()));
    return fheint16;
  }

  public static FheInt16 encryptTrivial(short clearValue) {
    FheInt16 fheint16 = new FheInt16();
    executeWithErrorHandling(() -> fhe_int16_try_encrypt_trivial_i16(clearValue, fheint16.getAddress()));
    return fheint16;
  }

  public static FheInt16 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt16 fheint16 = new FheInt16();
    executeWithErrorHandling(() -> fhe_int16_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint16.getAddress()));
    return fheint16;
  }
  ...
  public FheInt16 clone() {
    FheInt16 fheint16 = new FheInt16();
    executeWithErrorHandling(() -> fhe_int16_clone(getValue(), fheint16.getAddress()));
    return fheint16;
  }
}
