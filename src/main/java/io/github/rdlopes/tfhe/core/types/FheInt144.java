...
public class FheInt144 extends AddressLayoutPointer implements
  ...
  public static FheInt144
  encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt144 fhe = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt144 fhe = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt144 encryptTrivial(I256 clearValue) {
    FheInt144 fhe = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_try_encrypt_trivial_i256(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheInt144 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt144 fhe = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheInt144 scalarAnd(I256 scalar) {
    FheInt144 result = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(I256 scalar) {
    executeWithErrorHandling(() -> fhe_int144_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheInt144 scalarOr(I256 scalar) {
    FheInt144 result = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(I256 scalar) {
    executeWithErrorHandling(() -> fhe_int144_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheInt144 scalarXor(I256 scalar) {
    FheInt144 result = new FheInt144();
    executeWithErrorHandling(() -> fhe_int144_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(I256 scalar) {
    executeWithErrorHandling(() -> fhe_int144_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheInt144 clone() {
    ...
    executeWithErrorHandling(() -> fhe_int144_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
