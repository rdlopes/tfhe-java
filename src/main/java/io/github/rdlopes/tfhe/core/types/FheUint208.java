...
public class FheUint208 extends AddressLayoutPointer implements
  ...
  public static FheUint208
  encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint208 fhe = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint208 fhe = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint208 encryptTrivial(U256 clearValue) {
    FheUint208 fhe = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_try_encrypt_trivial_u256(clearValue.getAddress(), fhe.getAddress()));
    return fhe;
  }

  public static FheUint208 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint208 fhe = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fhe.getAddress()));
    return fhe;
  }
  ...
  public FheUint208 scalarAnd(U256 scalar) {
    FheUint208 result = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_scalar_bitand(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarAndAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint208_scalar_bitand_assign(getValue(), scalar.getAddress()));
  }

  public FheUint208 scalarOr(U256 scalar) {
    FheUint208 result = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_scalar_bitor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarOrAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint208_scalar_bitor_assign(getValue(), scalar.getAddress()));
  }

  public FheUint208 scalarXor(U256 scalar) {
    FheUint208 result = new FheUint208();
    executeWithErrorHandling(() -> fhe_uint208_scalar_bitxor(getValue(), scalar.getAddress(), result.getAddress()));
    return result;
  }

  public void scalarXorAssign(U256 scalar) {
    executeWithErrorHandling(() -> fhe_uint208_scalar_bitxor_assign(getValue(), scalar.getAddress()));
  }
  ...
  public FheUint208 clone() {
    ...
    executeWithErrorHandling(() -> fhe_uint208_clone(getValue(), cloned.getAddress()));
    return cloned;
  }
