...
public class FheUint176 extends AddressLayoutPointer implements Cloneable {

  protected FheUint176() {
    super(FheUint176.class, TfheWrapper::fhe_uint176_destroy);
  }

  public static FheUint176 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint176 fheuint176 = new FheUint176();
    executeWithErrorHandling(() -> fhe_uint176_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint176.getAddress()));
    return fheuint176;
  }

  public static FheUint176 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint176 fheuint176 = new FheUint176();
    executeWithErrorHandling(() -> fhe_uint176_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint176.getAddress()));
    return fheuint176;
  }

  public static FheUint176 encryptTrivial(U256 clearValue) {
    FheUint176 fheuint176 = new FheUint176();
    executeWithErrorHandling(() -> fhe_uint176_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint176.getAddress()));
    return fheuint176;
  }

  public static FheUint176 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint176 fheuint176 = new FheUint176();
    executeWithErrorHandling(() -> fhe_uint176_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint176.getAddress()));
    return fheuint176;
  }
  ...
  public FheUint176 clone() {
    FheUint176 fheuint176 = new FheUint176();
    executeWithErrorHandling(() -> fhe_uint176_clone(getValue(), fheuint176.getAddress()));
    return fheuint176;
  }
}
