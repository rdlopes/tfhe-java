...
public class FheInt168 extends AddressLayoutPointer implements Cloneable {

  protected FheInt168() {
    super(FheInt168.class, TfheWrapper::fhe_int168_destroy);
  }

  public static FheInt168 encryptWithClientKey(I256 clearValue, ClientKey clientKey) {
    FheInt168 fheint168 = new FheInt168();
    executeWithErrorHandling(() -> fhe_int168_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), fheint168.getAddress()));
    return fheint168;
  }

  public static FheInt168 encryptWithPublicKey(I256 clearValue, PublicKey publicKey) {
    FheInt168 fheint168 = new FheInt168();
    executeWithErrorHandling(() -> fhe_int168_try_encrypt_with_public_key_i256(clearValue.getAddress(), publicKey.getValue(), fheint168.getAddress()));
    return fheint168;
  }

  public static FheInt168 encryptTrivial(I256 clearValue) {
    FheInt168 fheint168 = new FheInt168();
    executeWithErrorHandling(() -> fhe_int168_try_encrypt_trivial_i256(clearValue.getAddress(), fheint168.getAddress()));
    return fheint168;
  }

  public static FheInt168 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheInt168 fheint168 = new FheInt168();
    executeWithErrorHandling(() -> fhe_int168_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheint168.getAddress()));
    return fheint168;
  }
  ...
  public FheInt168 clone() {
    FheInt168 fheint168 = new FheInt168();
    executeWithErrorHandling(() -> fhe_int168_clone(getValue(), fheint168.getAddress()));
    return fheint168;
  }
}
