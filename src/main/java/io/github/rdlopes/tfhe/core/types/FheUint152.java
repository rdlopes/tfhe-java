...
public class FheUint152 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint152 encryptWithClientKey(U256 clearValue, ClientKey clientKey) {
    FheUint152 fheuint152 = new FheUint152();
    executeWithErrorHandling(() -> fhe_uint152_try_encrypt_with_client_key_u256(clearValue.getAddress(), clientKey.getValue(), fheuint152.getAddress()));
    return fheuint152;
  }

  public static FheUint152 encryptWithPublicKey(U256 clearValue, PublicKey publicKey) {
    FheUint152 fheuint152 = new FheUint152();
    executeWithErrorHandling(() -> fhe_uint152_try_encrypt_with_public_key_u256(clearValue.getAddress(), publicKey.getValue(), fheuint152.getAddress()));
    return fheuint152;
  }

  public static FheUint152 encryptTrivial(U256 clearValue) {
    FheUint152 fheuint152 = new FheUint152();
    executeWithErrorHandling(() -> fhe_uint152_try_encrypt_trivial_u256(clearValue.getAddress(), fheuint152.getAddress()));
    return fheuint152;
  }

  public static FheUint152 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint152 fheuint152 = new FheUint152();
    executeWithErrorHandling(() -> fhe_uint152_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint152.getAddress()));
    return fheuint152;
  }
  ...
  public FheUint152 clone() {
    FheUint152 fheuint152 = new FheUint152();
    executeWithErrorHandling(() -> fhe_uint152_clone(getValue(), fheuint152.getAddress()));
    return fheuint152;
  }
}
