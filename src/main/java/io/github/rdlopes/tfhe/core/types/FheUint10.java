...
public class FheUint10 extends AddressLayoutPointer implements Cloneable {
  ...
  public static FheUint10 encryptWithClientKey(short clearValue, ClientKey clientKey) {
    FheUint10 fheuint10 = new FheUint10();
    executeWithErrorHandling(() -> fhe_uint10_try_encrypt_with_client_key_u16(clearValue, clientKey.getValue(), fheuint10.getAddress()));
    return fheuint10;
  }

  public static FheUint10 encryptWithPublicKey(short clearValue, PublicKey publicKey) {
    FheUint10 fheuint10 = new FheUint10();
    executeWithErrorHandling(() -> fhe_uint10_try_encrypt_with_public_key_u16(clearValue, publicKey.getValue(), fheuint10.getAddress()));
    return fheuint10;
  }

  public static FheUint10 encryptTrivial(short clearValue) {
    FheUint10 fheuint10 = new FheUint10();
    executeWithErrorHandling(() -> fhe_uint10_try_encrypt_trivial_u16(clearValue, fheuint10.getAddress()));
    return fheuint10;
  }

  public static FheUint10 deserialize(DynamicBufferView bufferView, ServerKey serverKey) {
    FheUint10 fheuint10 = new FheUint10();
    executeWithErrorHandling(() -> fhe_uint10_safe_deserialize_conformant(bufferView.getAddress(), BUFFER_MAX_SIZE, serverKey.getValue(), fheuint10.getAddress()));
    return fheuint10;
  }
  ...
  public FheUint10 clone() {
    FheUint10 fheuint10 = new FheUint10();
    executeWithErrorHandling(() -> fhe_uint10_clone(getValue(), fheuint10.getAddress()));
    return fheuint10;
  }
}
