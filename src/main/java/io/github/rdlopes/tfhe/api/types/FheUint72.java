...
// @formatter:off
public class FheUint72 extends NativePointer implements FheUnsignedInteger<U128, FheUint72, CompressedFheUint72> {
...
public FheUint72 clone() {
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint72, CompressedFheUint72> addWithOverflow(FheUint72 other) {
    FheUint72 result = new FheUint72();
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint72, CompressedFheUint72> subtractWithOverflow(FheUint72 other){
    FheUint72 result = new FheUint72();
    FheBool overflow = new FheBool();
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint72, CompressedFheUint72> multiplyWithOverflow(FheUint72 other) {
    FheUint72 result = new FheUint72();
    FheBool overflow = new FheBool();
  ...
  ///```
  @Override
  public DividerAndRemainder<U128, FheUint72, CompressedFheUint72> divideWithRemainder(FheUint72 other) {
  ...
  ///```
  @Override
  public DividerAndRemainder<U128, FheUint72, CompressedFheUint72> divideWithRemainderScalar(U128 other) {
    FheUint72 divider = new FheUint72();
    FheUint72 remainder = new FheUint72();
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint72, CompressedFheUint72> ilog2WithCheck() {
    FheUint72 result = new FheUint72();
  ...
  /// ```c
  /// int generate_oblivious_pseudo_random_fhe_uint72(struct FheUint72 **out_result,
  ///                                                 uint64_t seed_low_bytes,
  ///                                                 uint64_t seed_high_bytes);
  ///```
  @Override
  public FheUint72 random(long seedLow, long seedHigh) {
    FheUint72 result = new FheUint72();
    execute(() -> generate_oblivious_pseudo_random_fhe_uint72(result.getAddress(), seedLow, seedHigh));
    return result;

  }

  /// ```c
  /// int generate_oblivious_pseudo_random_bounded_fhe_uint72(struct FheUint72 **out_result,
  ///                                                         uint64_t seed_low_bytes,
  ///                                                         uint64_t seed_high_bytes,
  ///                                                         uint64_t random_bits_count);
  ///```
  @Override
  public FheUint72 random(long seedLow, long seedHigh, long bitsCount) {
    FheUint72 result = new FheUint72();
    execute(() -> generate_oblivious_pseudo_random_bounded_fhe_uint72(result.getAddress(), seedLow, seedHigh, bitsCount));
    return result;
