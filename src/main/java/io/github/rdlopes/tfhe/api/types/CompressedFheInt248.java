...
// @formatter:off
public class CompressedFheInt248 extends NativePointer implements CompressedFheType<I256, FheInt248, CompressedFheInt248> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int248_decompress(const struct CompressedFheInt248 *sself,
  ...
  ///  */
  /// int compressed_fhe_int248_safe_serialize(const struct CompressedFheInt248 *sself,
  ...
  ///  */
  /// int compressed_fhe_int248_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt248 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int248_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int248_clone(const struct CompressedFheInt248 *sself,
  ///                                 struct CompressedFheInt248 **result);
  ///```
  @Override
