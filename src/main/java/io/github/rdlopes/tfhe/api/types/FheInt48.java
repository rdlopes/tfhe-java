...
// @formatter:off
public class FheInt48 extends NativePointer implements FheInteger<Long, FheInt48, CompressedFheInt48> {
  private static final Logger logger = LoggerFactory.getLogger(FheInt48.class);
// @formatter:on
  ...
  ///  */
  /// int fhe_int48_destroy(struct FheInt48 *ptr);
  ///```
  FheInt48() {
    logger.trace("init");
    super(TfheHeader::fhe_int48_destroy);
  }
  ...
  ///  */
  /// int fhe_int48_safe_serialize(const struct FheInt48 *sself,
  ...
  public DynamicBuffer serialize() {
    ...
    execute(() -> fhe_int48_safe_serialize(getValue(), dynamicBuffer.getAddress(), BUFFER_MAX_SIZE));
  ...
  /// ```c
  /// int fhe_int48_bitand(const struct FheInt48 *lhs,
...
public void bitAndAssign(FheInt48 other){
  ...
  /// ```c
  /// int fhe_int48_scalar_bitand_assign(struct FheInt48 *lhs, int64_t rhs);
  ///```
  @Override
  public void bitAndScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_bitand_assign(getValue(), other));

  }

  /// ```c
  /// int fhe_int48_bitor(const struct FheInt48 *lhs,
  ///                     const struct FheInt48 *rhs,
  ///                     struct FheInt48 **result);
  ///```
@Override
...
public void bitOrAssign(FheInt48 other){
  ...
  public void bitOrScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_bitor_assign(getValue(), other));
...
public void bitXorAssign(FheInt48 other) {
  ...
  public void bitXorScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_bitxor_assign(getValue(), other));
...
public FheInt48 bitNot(){
  ...
  ///                            const struct FheInt48 *then_ct,
  ///                            const struct FheInt48 *else_ct,
  ///                            struct FheInt48 **result);
  ///```
  @SuppressWarnings("unused")
  public static FheInt48 ifThenElse(FheBool condition, FheInt48 thenValue, FheInt48 elseValue) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_if_then_else(condition.getValue(), thenValue.getValue(), elseValue.getValue(), result.getAddress()));
    return result;
...
public FheBool notEqualTo(FheInt48 other){
  ...
  ///  */
  /// int fhe_int48_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                           uint64_t serialized_size_limit,
...
///```
public static FheInt48 encrypt(Long clearValue) {
  FheInt48 encrypted = new FheInt48();
  execute(() -> fhe_int48_try_encrypt_trivial_i64(clearValue, encrypted.getAddress()));
  return encrypted;
...
public FheInt48 clone() {
  ...
  public Long decrypt(ClientKey clientKey) {
    return executeAndReturn(Long.class, address -> fhe_int48_decrypt(getValue(), clientKey.getValue(), address));
  ...
  ///```
  @Override
  public CheckedResult<Long, FheInt48, CompressedFheInt48> addWithOverflow(FheInt48 other) {
    FheInt48 result = new FheInt48();
  ...
  ///```
  @Override
  public FheInt48 addScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_add(getValue(), other, result.getAddress()));
    return result;
  ...
  public void addScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_add_assign(getValue(), other));
  ...
  ///```
  @Override
  public CheckedResult<Long, FheInt48, CompressedFheInt48> subtractWithOverflow(FheInt48 other) {
    FheInt48 result = new FheInt48();
    FheBool overflow = new FheBool();
  ...
  ///```
  @Override
  public FheInt48 subtractScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_sub(getValue(), other, result.getAddress()));
    return result;
  ...
  public void subtractScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_sub_assign(getValue(), other));
  ...
  ///```
  @Override
  public CheckedResult<Long, FheInt48, CompressedFheInt48> multiplyWithOverflow(FheInt48 other) {
    FheInt48 result = new FheInt48();
    FheBool overflow = new FheBool();
  ...
  ///```
  @Override
  public FheInt48 multiplyScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_mul(getValue(), other, result.getAddress()));
    return result;
  ...
  public void multiplyScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_mul_assign(getValue(), other));
  ...
  public void divideScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_div_assign(getValue(), other));
  ...
  public void remainderScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_rem_assign(getValue(), other));

  }

  /// ```c
  /// int fhe_int48_div_rem(const struct FheInt48 *lhs,
  ///                       const struct FheInt48 *rhs,
  ///                       struct FheInt48 **q_result,
  ///                       struct FheInt48 **r_result);
  ///```
  @Override
  public DividerAndRemainder<Long, FheInt48, CompressedFheInt48> divideWithRemainder(FheInt48 other) {
  ...
  ///```
  @Override
  public DividerAndRemainder<Long, FheInt48, CompressedFheInt48> divideWithRemainderScalar(Long other) {
    FheInt48 divider = new FheInt48();
    FheInt48 remainder = new FheInt48();
  ...
  ///```
  @Override
  public CheckedResult<Long, FheInt48, CompressedFheInt48> ilog2WithCheck() {
    FheInt48 result = new FheInt48();
  ...
  public FheBool lessThanScalar(Long other) {
    FheBool result = new FheBool();
    execute(() -> fhe_int48_scalar_lt(getValue(), other, result.getAddress()));
    return result;
  ...
  public FheBool lessThanOrEqualToScalar(Long other) {
    FheBool result = new FheBool();
    execute(() -> fhe_int48_scalar_le(getValue(), other, result.getAddress()));
    return result;
  ...
  public FheBool greaterThanScalar(Long other) {
    FheBool result = new FheBool();
    execute(() -> fhe_int48_scalar_gt(getValue(), other, result.getAddress()));
    return result;
  ...
  public FheBool greaterThanOrEqualToScalar(Long other) {
    FheBool result = new FheBool();
    execute(() -> fhe_int48_scalar_ge(getValue(), other, result.getAddress()));
    return result;
  ...
  ///```
  @Override
  public FheInt48 minScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_min(getValue(), other, result.getAddress()));
    return result;
  ...
  ///```
  @Override
  public FheInt48 maxScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_max(getValue(), other, result.getAddress()));
    return result;
  ...
  ///```
  @Override
  public FheInt48 shiftLeftScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_shl(getValue(), other, result.getAddress()));
    return result;
  ...
  public void shiftLeftAssign(FheInt48 other) {
    execute(() -> fhe_int48_shl_assign(getValue(), other.getValue()));

  }

  /// ```c
  /// int fhe_int48_scalar_shl_assign(struct FheInt48 *lhs, uint64_t rhs);
  ///```
  @Override
  public void shiftLeftScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_shl_assign(getValue(), other));
  ...
  ///```
  @Override
  public FheInt48 shiftRightScalar(Long other) {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_scalar_shr(getValue(), other, result.getAddress()));
    return result;
  ...
  public void shiftRightAssign(FheInt48 other) {
    execute(() -> fhe_int48_shr_assign(getValue(), other.getValue()));

  }

  /// ```c
  /// int fhe_int48_scalar_shr_assign(struct FheInt48 *lhs, uint64_t rhs);
  ///```
  @Override
  public void shiftRightScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_shr_assign(getValue(), other));
  ...
  /// ```c
  /// int fhe_int48_rotate_left_assign(struct FheInt48 *lhs, const struct FheUint48 *rhs);
  ///```
  @Override
  public void rotateLeftAssign(FheInt48 other) {
    execute(() -> fhe_int48_rotate_left_assign(getValue(), other.getValue()));

  }

  /// ```c
  /// int fhe_int48_scalar_rotate_left_assign(struct FheInt48 *lhs, uint64_t rhs);
  ///```
  @Override
  public void rotateLeftScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_rotate_left_assign(getValue(), other));
  ...
  /// ```c
  /// int fhe_int48_rotate_right_assign(struct FheInt48 *lhs, const struct FheUint48 *rhs);
  ///```
  @Override
  public void rotateRightAssign(FheInt48 other) {
    execute(() -> fhe_int48_rotate_right_assign(getValue(), other.getValue()));

  }

  /// ```c
  /// int fhe_int48_scalar_rotate_right_assign(struct FheInt48 *lhs, uint64_t rhs);
  ///```
  @Override
  public void rotateRightScalarAssign(Long other) {
    execute(() -> fhe_int48_scalar_rotate_right_assign(getValue(), other));
  ...
  /// ```c
  /// int generate_oblivious_pseudo_random_fhe_int48(struct FheInt48 **out_result,
  ///                                                uint64_t seed_low_bytes,
  ///                                                uint64_t seed_high_bytes);
  ///```
  @Override
  public FheInt48 random(long seedLow, long seedHigh) {
    FheInt48 result = new FheInt48();
    execute(() -> generate_oblivious_pseudo_random_fhe_int48(result.getAddress(), seedLow, seedHigh));
    return result;

  }

  /// ```c
  /// int generate_oblivious_pseudo_random_bounded_fhe_int48(struct FheInt48 **out_result,
  ///                                                        uint64_t seed_low_bytes,
  ///                                                        uint64_t seed_high_bytes,
  ///                                                        uint64_t random_bits_count);
  ///```
  @Override
  public FheInt48 random(long seedLow, long seedHigh, long bitsCount){
      FheInt48 result = new FheInt48();
    execute(() -> generate_oblivious_pseudo_random_bounded_fhe_int48(result.getAddress(), seedLow, seedHigh, bitsCount));
    return result;
  ...
  public FheInt10 castIntoFheInt10() {
    ...
    execute(() -> fhe_int48_cast_into_fhe_int10(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int1024(const struct FheInt48 *sself, struct FheInt1024 **result);
  ///```
  public FheInt1024 castIntoFheInt1024() {
    FheInt1024 result = new FheInt1024();
    execute(() -> fhe_int48_cast_into_fhe_int1024(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int104(const struct FheInt48 *sself, struct FheInt104 **result);
  ///```
  public FheInt104 castIntoFheInt104() {
    FheInt104 result = new FheInt104();
    execute(() -> fhe_int48_cast_into_fhe_int104(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int112(const struct FheInt48 *sself, struct FheInt112 **result);
  ///```
  public FheInt112 castIntoFheInt112() {
    FheInt112 result = new FheInt112();
    execute(() -> fhe_int48_cast_into_fhe_int112(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int12(const struct FheInt48 *sself, struct FheInt12 **result);
  ///```
  public FheInt12 castIntoFheInt12() {
    FheInt12 result = new FheInt12();
    execute(() -> fhe_int48_cast_into_fhe_int12(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int120(const struct FheInt48 *sself, struct FheInt120 **result);
  ///```
  public FheInt120 castIntoFheInt120() {
    FheInt120 result = new FheInt120();
    execute(() -> fhe_int48_cast_into_fhe_int120(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int128(const struct FheInt48 *sself, struct FheInt128 **result);
  ///```
  public FheInt128 castIntoFheInt128() {
    FheInt128 result = new FheInt128();
    execute(() -> fhe_int48_cast_into_fhe_int128(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int136(const struct FheInt48 *sself, struct FheInt136 **result);
  ///```
  public FheInt136 castIntoFheInt136() {
    FheInt136 result = new FheInt136();
    execute(() -> fhe_int48_cast_into_fhe_int136(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int14(const struct FheInt48 *sself, struct FheInt14 **result);
  ///```
  public FheInt14 castIntoFheInt14() {
    FheInt14 result = new FheInt14();
    execute(() -> fhe_int48_cast_into_fhe_int14(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int144(const struct FheInt48 *sself, struct FheInt144 **result);
  ///```
  public FheInt144 castIntoFheInt144() {
    FheInt144 result = new FheInt144();
    execute(() -> fhe_int48_cast_into_fhe_int144(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int152(const struct FheInt48 *sself, struct FheInt152 **result);
  ///```
  public FheInt152 castIntoFheInt152() {
    FheInt152 result = new FheInt152();
    execute(() -> fhe_int48_cast_into_fhe_int152(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int16(const struct FheInt48 *sself, struct FheInt16 **result);
  ///```
  public FheInt16 castIntoFheInt16() {
    FheInt16 result = new FheInt16();
    execute(() -> fhe_int48_cast_into_fhe_int16(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int160(const struct FheInt48 *sself, struct FheInt160 **result);
  ///```
  public FheInt160 castIntoFheInt160() {
    FheInt160 result = new FheInt160();
    execute(() -> fhe_int48_cast_into_fhe_int160(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int168(const struct FheInt48 *sself, struct FheInt168 **result);
  ///```
  public FheInt168 castIntoFheInt168() {
    FheInt168 result = new FheInt168();
    execute(() -> fhe_int48_cast_into_fhe_int168(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int176(const struct FheInt48 *sself, struct FheInt176 **result);
  ///```
  public FheInt176 castIntoFheInt176() {
    FheInt176 result = new FheInt176();
    execute(() -> fhe_int48_cast_into_fhe_int176(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int184(const struct FheInt48 *sself, struct FheInt184 **result);
  ///```
  public FheInt184 castIntoFheInt184() {
    FheInt184 result = new FheInt184();
    execute(() -> fhe_int48_cast_into_fhe_int184(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int192(const struct FheInt48 *sself, struct FheInt192 **result);
  ///```
  public FheInt192 castIntoFheInt192() {
    FheInt192 result = new FheInt192();
    execute(() -> fhe_int48_cast_into_fhe_int192(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int2(const struct FheInt48 *sself, struct FheInt2 **result);
  ///```
  public FheInt2 castIntoFheInt2() {
    FheInt2 result = new FheInt2();
    execute(() -> fhe_int48_cast_into_fhe_int2(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int200(const struct FheInt48 *sself, struct FheInt200 **result);
  ///```
  public FheInt200 castIntoFheInt200() {
    FheInt200 result = new FheInt200();
    execute(() -> fhe_int48_cast_into_fhe_int200(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int2048(const struct FheInt48 *sself, struct FheInt2048 **result);
  ///```
  public FheInt2048 castIntoFheInt2048() {
    FheInt2048 result = new FheInt2048();
    execute(() -> fhe_int48_cast_into_fhe_int2048(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int208(const struct FheInt48 *sself, struct FheInt208 **result);
  ///```
  public FheInt208 castIntoFheInt208() {
    FheInt208 result = new FheInt208();
    execute(() -> fhe_int48_cast_into_fhe_int208(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int216(const struct FheInt48 *sself, struct FheInt216 **result);
  ///```
  public FheInt216 castIntoFheInt216() {
    FheInt216 result = new FheInt216();
    execute(() -> fhe_int48_cast_into_fhe_int216(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int224(const struct FheInt48 *sself, struct FheInt224 **result);
  ///```
  public FheInt224 castIntoFheInt224() {
    FheInt224 result = new FheInt224();
    execute(() -> fhe_int48_cast_into_fhe_int224(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int232(const struct FheInt48 *sself, struct FheInt232 **result);
  ///```
  public FheInt232 castIntoFheInt232() {
    FheInt232 result = new FheInt232();
    execute(() -> fhe_int48_cast_into_fhe_int232(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int24(const struct FheInt48 *sself, struct FheInt24 **result);
  ///```
  public FheInt24 castIntoFheInt24() {
    FheInt24 result = new FheInt24();
    execute(() -> fhe_int48_cast_into_fhe_int24(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int240(const struct FheInt48 *sself, struct FheInt240 **result);
  ///```
  public FheInt240 castIntoFheInt240() {
    FheInt240 result = new FheInt240();
    execute(() -> fhe_int48_cast_into_fhe_int240(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int248(const struct FheInt48 *sself, struct FheInt248 **result);
  ///```
  public FheInt248 castIntoFheInt248() {
    FheInt248 result = new FheInt248();
    execute(() -> fhe_int48_cast_into_fhe_int248(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int256(const struct FheInt48 *sself, struct FheInt256 **result);
  ///```
  public FheInt256 castIntoFheInt256() {
    FheInt256 result = new FheInt256();
    execute(() -> fhe_int48_cast_into_fhe_int256(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int32(const struct FheInt48 *sself, struct FheInt32 **result);
  ///```
  public FheInt32 castIntoFheInt32() {
    FheInt32 result = new FheInt32();
    execute(() -> fhe_int48_cast_into_fhe_int32(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int4(const struct FheInt48 *sself, struct FheInt4 **result);
  ///```
  public FheInt4 castIntoFheInt4() {
    FheInt4 result = new FheInt4();
    execute(() -> fhe_int48_cast_into_fhe_int4(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int40(const struct FheInt48 *sself, struct FheInt40 **result);
  ///```
  public FheInt40 castIntoFheInt40() {
    FheInt40 result = new FheInt40();
    execute(() -> fhe_int48_cast_into_fhe_int40(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int48(const struct FheInt48 *sself, struct FheInt48 **result);
  ///```
  public FheInt48 castIntoFheInt48() {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int48_cast_into_fhe_int48(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int512(const struct FheInt48 *sself, struct FheInt512 **result);
  ///```
  public FheInt512 castIntoFheInt512() {
    FheInt512 result = new FheInt512();
    execute(() -> fhe_int48_cast_into_fhe_int512(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int56(const struct FheInt48 *sself, struct FheInt56 **result);
  ///```
  public FheInt56 castIntoFheInt56() {
    FheInt56 result = new FheInt56();
    execute(() -> fhe_int48_cast_into_fhe_int56(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int6(const struct FheInt48 *sself, struct FheInt6 **result);
  ///```
  public FheInt6 castIntoFheInt6() {
    FheInt6 result = new FheInt6();
    execute(() -> fhe_int48_cast_into_fhe_int6(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int64(const struct FheInt48 *sself, struct FheInt64 **result);
  ///```
  public FheInt64 castIntoFheInt64() {
    FheInt64 result = new FheInt64();
    execute(() -> fhe_int48_cast_into_fhe_int64(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int72(const struct FheInt48 *sself, struct FheInt72 **result);
  ///```
  public FheInt72 castIntoFheInt72() {
    FheInt72 result = new FheInt72();
    execute(() -> fhe_int48_cast_into_fhe_int72(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int8(const struct FheInt48 *sself, struct FheInt8 **result);
  ///```
  public FheInt8 castIntoFheInt8() {
    FheInt8 result = new FheInt8();
    execute(() -> fhe_int48_cast_into_fhe_int8(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int80(const struct FheInt48 *sself, struct FheInt80 **result);
  ///```
  public FheInt80 castIntoFheInt80() {
    FheInt80 result = new FheInt80();
    execute(() -> fhe_int48_cast_into_fhe_int80(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int88(const struct FheInt48 *sself, struct FheInt88 **result);
  ///```
  public FheInt88 castIntoFheInt88() {
    FheInt88 result = new FheInt88();
    execute(() -> fhe_int48_cast_into_fhe_int88(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_int96(const struct FheInt48 *sself, struct FheInt96 **result);
  ///```
  public FheInt96 castIntoFheInt96() {
    FheInt96 result = new FheInt96();
    execute(() -> fhe_int48_cast_into_fhe_int96(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint10(const struct FheInt48 *sself, struct FheUint10 **result);
  ///```
  public FheUint10 castIntoFheUint10() {
    FheUint10 result = new FheUint10();
    execute(() -> fhe_int48_cast_into_fhe_uint10(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint1024(const struct FheInt48 *sself, struct FheUint1024 **result);
  ///```
  public FheUint1024 castIntoFheUint1024() {
    FheUint1024 result = new FheUint1024();
    execute(() -> fhe_int48_cast_into_fhe_uint1024(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint104(const struct FheInt48 *sself, struct FheUint104 **result);
  ///```
  public FheUint104 castIntoFheUint104() {
    FheUint104 result = new FheUint104();
    execute(() -> fhe_int48_cast_into_fhe_uint104(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint112(const struct FheInt48 *sself, struct FheUint112 **result);
  ///```
  public FheUint112 castIntoFheUint112() {
    FheUint112 result = new FheUint112();
    execute(() -> fhe_int48_cast_into_fhe_uint112(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint12(const struct FheInt48 *sself, struct FheUint12 **result);
  ///```
  public FheUint12 castIntoFheUint12() {
    FheUint12 result = new FheUint12();
    execute(() -> fhe_int48_cast_into_fhe_uint12(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint120(const struct FheInt48 *sself, struct FheUint120 **result);
  ///```
  public FheUint120 castIntoFheUint120() {
    FheUint120 result = new FheUint120();
    execute(() -> fhe_int48_cast_into_fhe_uint120(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint128(const struct FheInt48 *sself, struct FheUint128 **result);
  ///```
  public FheUint128 castIntoFheUint128() {
    FheUint128 result = new FheUint128();
    execute(() -> fhe_int48_cast_into_fhe_uint128(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint136(const struct FheInt48 *sself, struct FheUint136 **result);
  ///```
  public FheUint136 castIntoFheUint136() {
    FheUint136 result = new FheUint136();
    execute(() -> fhe_int48_cast_into_fhe_uint136(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint14(const struct FheInt48 *sself, struct FheUint14 **result);
  ///```
  public FheUint14 castIntoFheUint14() {
    FheUint14 result = new FheUint14();
    execute(() -> fhe_int48_cast_into_fhe_uint14(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint144(const struct FheInt48 *sself, struct FheUint144 **result);
  ///```
  public FheUint144 castIntoFheUint144() {
    FheUint144 result = new FheUint144();
    execute(() -> fhe_int48_cast_into_fhe_uint144(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint152(const struct FheInt48 *sself, struct FheUint152 **result);
  ///```
  public FheUint152 castIntoFheUint152() {
    FheUint152 result = new FheUint152();
    execute(() -> fhe_int48_cast_into_fhe_uint152(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint16(const struct FheInt48 *sself, struct FheUint16 **result);
  ///```
public FheUint16 castIntoFheUint16() {
  FheUint16 result = new FheUint16();
  execute(() -> fhe_int48_cast_into_fhe_uint16(getValue(), result.getAddress()));
  return result;
}

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint160(const struct FheInt48 *sself, struct FheUint160 **result);
  ///```
  public FheUint160 castIntoFheUint160() {
    FheUint160 result = new FheUint160();
    execute(() -> fhe_int48_cast_into_fhe_uint160(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint168(const struct FheInt48 *sself, struct FheUint168 **result);
  ///```
  public FheUint168 castIntoFheUint168() {
    FheUint168 result = new FheUint168();
    execute(() -> fhe_int48_cast_into_fhe_uint168(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint176(const struct FheInt48 *sself, struct FheUint176 **result);
  ///```
  public FheUint176 castIntoFheUint176() {
    FheUint176 result = new FheUint176();
    execute(() -> fhe_int48_cast_into_fhe_uint176(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint184(const struct FheInt48 *sself, struct FheUint184 **result);
  ///```
  public FheUint184 castIntoFheUint184() {
    FheUint184 result = new FheUint184();
    execute(() -> fhe_int48_cast_into_fhe_uint184(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint192(const struct FheInt48 *sself, struct FheUint192 **result);
  ///```
  public FheUint192 castIntoFheUint192() {
    FheUint192 result = new FheUint192();
    execute(() -> fhe_int48_cast_into_fhe_uint192(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint2(const struct FheInt48 *sself, struct FheUint2 **result);
  ///```
  public FheUint2 castIntoFheUint2() {
    FheUint2 result = new FheUint2();
    execute(() -> fhe_int48_cast_into_fhe_uint2(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint200(const struct FheInt48 *sself, struct FheUint200 **result);
  ///```
  public FheUint200 castIntoFheUint200() {
    FheUint200 result = new FheUint200();
    execute(() -> fhe_int48_cast_into_fhe_uint200(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint2048(const struct FheInt48 *sself, struct FheUint2048 **result);
  ///```
  public FheUint2048 castIntoFheUint2048() {
    FheUint2048 result = new FheUint2048();
    execute(() -> fhe_int48_cast_into_fhe_uint2048(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint208(const struct FheInt48 *sself, struct FheUint208 **result);
  ///```
  public FheUint208 castIntoFheUint208() {
    FheUint208 result = new FheUint208();
    execute(() -> fhe_int48_cast_into_fhe_uint208(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint216(const struct FheInt48 *sself, struct FheUint216 **result);
  ///```
  public FheUint216 castIntoFheUint216() {
    FheUint216 result = new FheUint216();
    execute(() -> fhe_int48_cast_into_fhe_uint216(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint224(const struct FheInt48 *sself, struct FheUint224 **result);
  ///```
  public FheUint224 castIntoFheUint224() {
    FheUint224 result = new FheUint224();
    execute(() -> fhe_int48_cast_into_fhe_uint224(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint232(const struct FheInt48 *sself, struct FheUint232 **result);
  ///```
  public FheUint232 castIntoFheUint232() {
    FheUint232 result = new FheUint232();
    execute(() -> fhe_int48_cast_into_fhe_uint232(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint24(const struct FheInt48 *sself, struct FheUint24 **result);
  ///```
  public FheUint24 castIntoFheUint24() {
    FheUint24 result = new FheUint24();
    execute(() -> fhe_int48_cast_into_fhe_uint24(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint240(const struct FheInt48 *sself, struct FheUint240 **result);
  ///```
  public FheUint240 castIntoFheUint240() {
    FheUint240 result = new FheUint240();
    execute(() -> fhe_int48_cast_into_fhe_uint240(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint248(const struct FheInt48 *sself, struct FheUint248 **result);
  ///```
  public FheUint248 castIntoFheUint248() {
    FheUint248 result = new FheUint248();
    execute(() -> fhe_int48_cast_into_fhe_uint248(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint256(const struct FheInt48 *sself, struct FheUint256 **result);
  ///```
  public FheUint256 castIntoFheUint256() {
    FheUint256 result = new FheUint256();
    execute(() -> fhe_int48_cast_into_fhe_uint256(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint32(const struct FheInt48 *sself, struct FheUint32 **result);
  ///```
  public FheUint32 castIntoFheUint32() {
    FheUint32 result = new FheUint32();
    execute(() -> fhe_int48_cast_into_fhe_uint32(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint4(const struct FheInt48 *sself, struct FheUint4 **result);
  ///```
  public FheUint4 castIntoFheUint4() {
    FheUint4 result = new FheUint4();
    execute(() -> fhe_int48_cast_into_fhe_uint4(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint40(const struct FheInt48 *sself, struct FheUint40 **result);
  ///```
  public FheUint40 castIntoFheUint40() {
    FheUint40 result = new FheUint40();
    execute(() -> fhe_int48_cast_into_fhe_uint40(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint48(const struct FheInt48 *sself, struct FheUint48 **result);
  ///```
  public FheUint48 castIntoFheUint48() {
    FheUint48 result = new FheUint48();
    execute(() -> fhe_int48_cast_into_fhe_uint48(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint512(const struct FheInt48 *sself, struct FheUint512 **result);
  ///```
  public FheUint512 castIntoFheUint512() {
    FheUint512 result = new FheUint512();
    execute(() -> fhe_int48_cast_into_fhe_uint512(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint56(const struct FheInt48 *sself, struct FheUint56 **result);
  ///```
  public FheUint56 castIntoFheUint56() {
    FheUint56 result = new FheUint56();
    execute(() -> fhe_int48_cast_into_fhe_uint56(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint6(const struct FheInt48 *sself, struct FheUint6 **result);
  ///```
  public FheUint6 castIntoFheUint6() {
    FheUint6 result = new FheUint6();
    execute(() -> fhe_int48_cast_into_fhe_uint6(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint64(const struct FheInt48 *sself, struct FheUint64 **result);
  ///```
  public FheUint64 castIntoFheUint64() {
    FheUint64 result = new FheUint64();
    execute(() -> fhe_int48_cast_into_fhe_uint64(getValue(), result.getAddress()));
    return result;
}

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint72(const struct FheInt48 *sself, struct FheUint72 **result);
  ///```
  public FheUint72 castIntoFheUint72() {
    FheUint72 result = new FheUint72();
    execute(() -> fhe_int48_cast_into_fhe_uint72(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int48_cast_into_fhe_uint8(const struct FheInt48 *sself, struct FheUint8 **result);
  ///```
  public FheUint8 castIntoFheUint8() {
    FheUint8 result = new FheUint8();
    execute(() -> fhe_int48_cast_into_fhe_uint8(getValue(), result.getAddress()));
    return result;
}

/// ```c
/// int fhe_int48_cast_into_fhe_uint80(const struct FheInt48 *sself, struct FheUint80 **result);
///```
public FheUint80 castIntoFheUint80() {
  FheUint80 result = new FheUint80();
  execute(() -> fhe_int48_cast_into_fhe_uint80(getValue(), result.getAddress()));
  return result;
}

/// ```c
/// int fhe_int48_cast_into_fhe_uint88(const struct FheInt48 *sself, struct FheUint88 **result);
///```
public FheUint88 castIntoFheUint88() {
  FheUint88 result = new FheUint88();
  execute(() -> fhe_int48_cast_into_fhe_uint88(getValue(), result.getAddress()));
  return result;
}
