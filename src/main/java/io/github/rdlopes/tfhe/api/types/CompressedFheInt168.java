...
// @formatter:off
public class CompressedFheInt168 extends NativePointer implements CompressedFheType<I256, FheInt168, CompressedFheInt168> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int168_decompress(const struct CompressedFheInt168 *sself,
  ...
  ///  */
  /// int compressed_fhe_int168_safe_serialize(const struct CompressedFheInt168 *sself,
  ...
  ///  */
  /// int compressed_fhe_int168_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt168 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int168_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int168_clone(const struct CompressedFheInt168 *sself,
  ///                                 struct CompressedFheInt168 **result);
  ///```
  @Override
