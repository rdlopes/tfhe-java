...
// @formatter:off
public class CompressedFheInt216 extends NativePointer implements CompressedFheType<I256, FheInt216, CompressedFheInt216> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int216_decompress(const struct CompressedFheInt216 *sself,
  ...
  ///  */
  /// int compressed_fhe_int216_safe_serialize(const struct CompressedFheInt216 *sself,
  ...
  ///  */
  /// int compressed_fhe_int216_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_int216_try_encrypt_with_client_key_i256(struct I256 value,
