...
// @formatter:off
public class CompressedFheInt88 extends NativePointer implements CompressedFheType<I128, FheInt88, CompressedFheInt88> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int88_decompress(const struct CompressedFheInt88 *sself,
  ...
  ///  */
  /// int compressed_fhe_int88_safe_serialize(const struct CompressedFheInt88 *sself,
  ...
  ///  */
  /// int compressed_fhe_int88_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                      uint64_t serialized_size_limit,
  ///                                                      const struct ServerKey *server_key,
  ///                                                      struct CompressedFheInt88 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int88_try_encrypt_with_client_key_i128(struct I128 value,
  ...
  /// ```c
  /// int compressed_fhe_int88_clone(const struct CompressedFheInt88 *sself,
  ///                                struct CompressedFheInt88 **result);
  ///```
  @Override
