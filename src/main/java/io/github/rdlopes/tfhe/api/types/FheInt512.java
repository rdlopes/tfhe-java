...
// @formatter:off
public class FheInt512 extends NativePointer
implements FheInteger<I512, FheInt512, CompressedFheInt512> {
...
/// ```
@Override
public Map.Entry<FheInt512, FheBool> addWithOverflow(FheInt512 other){
    FheInt512 result = new FheInt512();
...
/// ```
@Override
public Map.Entry<FheInt512, FheBool> subtractWithOverflow(FheInt512 other){
    FheInt512 result = new FheInt512();
    FheBool overflow = new FheBool();
...
/// ```
@Override
public Map.Entry<FheInt512, FheBool> multiplyWithOverflow(FheInt512 other){
    FheInt512 result = new FheInt512();
    FheBool overflow = new FheBool();
...
/// ```
@Override
public Map.Entry<FheInt512,FheInt512> divideWithRemainder(FheInt512 other){
...
/// ```
@Override
public Map.Entry<FheInt512, FheInt512> divideWithRemainderScalar(I512 other) {
  FheInt512 divider = new FheInt512();
  FheInt512 remainder = new FheInt512();
...
public FheInt512 ilog2() {
  ...
  ///```
  @Override
  public Map.Entry<FheInt512, FheBool> ilog2WithCheck() {
    FheInt512 result = new FheInt512();
...
public FheInt512 trailingZeros() {
  ...
  public I512 decrypt(ClientKey clientKey) {
    ...
    executeWithAddress(decrypted.getAddress(), address -> fhe_int512_decrypt(getValue(), clientKey.getValue(), address));
    return decrypted;
...
public FheInt512 abs() {
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int104(const struct FheInt512 *sself, struct FheInt104 **result);
  ///```
  public FheInt104 castIntoFheInt104() {
    FheInt104 result = new FheInt104();
    execute(() -> fhe_int512_cast_into_fhe_int104(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int112(const struct FheInt512 *sself, struct FheInt112 **result);
  ///```
  public FheInt112 castIntoFheInt112() {
    FheInt112 result = new FheInt112();
    execute(() -> fhe_int512_cast_into_fhe_int112(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int120(const struct FheInt512 *sself, struct FheInt120 **result);
  ///```
  public FheInt120 castIntoFheInt120() {
    FheInt120 result = new FheInt120();
    execute(() -> fhe_int512_cast_into_fhe_int120(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int136(const struct FheInt512 *sself, struct FheInt136 **result);
  ///```
  public FheInt136 castIntoFheInt136() {
    FheInt136 result = new FheInt136();
    execute(() -> fhe_int512_cast_into_fhe_int136(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int144(const struct FheInt512 *sself, struct FheInt144 **result);
  ///```
  public FheInt144 castIntoFheInt144() {
    FheInt144 result = new FheInt144();
    execute(() -> fhe_int512_cast_into_fhe_int144(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int152(const struct FheInt512 *sself, struct FheInt152 **result);
  ///```
  public FheInt152 castIntoFheInt152() {
    FheInt152 result = new FheInt152();
    execute(() -> fhe_int512_cast_into_fhe_int152(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int168(const struct FheInt512 *sself, struct FheInt168 **result);
  ///```
  public FheInt168 castIntoFheInt168() {
    FheInt168 result = new FheInt168();
    execute(() -> fhe_int512_cast_into_fhe_int168(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int176(const struct FheInt512 *sself, struct FheInt176 **result);
  ///```
  public FheInt176 castIntoFheInt176() {
    FheInt176 result = new FheInt176();
    execute(() -> fhe_int512_cast_into_fhe_int176(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int184(const struct FheInt512 *sself, struct FheInt184 **result);
  ///```
  public FheInt184 castIntoFheInt184() {
    FheInt184 result = new FheInt184();
    execute(() -> fhe_int512_cast_into_fhe_int184(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int192(const struct FheInt512 *sself, struct FheInt192 **result);
  ///```
  public FheInt192 castIntoFheInt192() {
    FheInt192 result = new FheInt192();
    execute(() -> fhe_int512_cast_into_fhe_int192(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int200(const struct FheInt512 *sself, struct FheInt200 **result);
  ///```
  public FheInt200 castIntoFheInt200() {
    FheInt200 result = new FheInt200();
    execute(() -> fhe_int512_cast_into_fhe_int200(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int208(const struct FheInt512 *sself, struct FheInt208 **result);
  ///```
  public FheInt208 castIntoFheInt208() {
    FheInt208 result = new FheInt208();
    execute(() -> fhe_int512_cast_into_fhe_int208(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int216(const struct FheInt512 *sself, struct FheInt216 **result);
  ///```
  public FheInt216 castIntoFheInt216() {
    FheInt216 result = new FheInt216();
    execute(() -> fhe_int512_cast_into_fhe_int216(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int224(const struct FheInt512 *sself, struct FheInt224 **result);
  ///```
  public FheInt224 castIntoFheInt224() {
    FheInt224 result = new FheInt224();
    execute(() -> fhe_int512_cast_into_fhe_int224(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int232(const struct FheInt512 *sself, struct FheInt232 **result);
  ///```
  public FheInt232 castIntoFheInt232() {
    FheInt232 result = new FheInt232();
    execute(() -> fhe_int512_cast_into_fhe_int232(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int24(const struct FheInt512 *sself, struct FheInt24 **result);
  ///```
  public FheInt24 castIntoFheInt24() {
    FheInt24 result = new FheInt24();
    execute(() -> fhe_int512_cast_into_fhe_int24(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int240(const struct FheInt512 *sself, struct FheInt240 **result);
  ///```
  public FheInt240 castIntoFheInt240() {
    FheInt240 result = new FheInt240();
    execute(() -> fhe_int512_cast_into_fhe_int240(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int248(const struct FheInt512 *sself, struct FheInt248 **result);
  ///```
  public FheInt248 castIntoFheInt248() {
    FheInt248 result = new FheInt248();
    execute(() -> fhe_int512_cast_into_fhe_int248(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int40(const struct FheInt512 *sself, struct FheInt40 **result);
  ///```
  public FheInt40 castIntoFheInt40() {
    FheInt40 result = new FheInt40();
    execute(() -> fhe_int512_cast_into_fhe_int40(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int48(const struct FheInt512 *sself, struct FheInt48 **result);
  ///```
  public FheInt48 castIntoFheInt48() {
    FheInt48 result = new FheInt48();
    execute(() -> fhe_int512_cast_into_fhe_int48(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int56(const struct FheInt512 *sself, struct FheInt56 **result);
  ///```
  public FheInt56 castIntoFheInt56() {
    FheInt56 result = new FheInt56();
    execute(() -> fhe_int512_cast_into_fhe_int56(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int72(const struct FheInt512 *sself, struct FheInt72 **result);
  ///```
  public FheInt72 castIntoFheInt72() {
    FheInt72 result = new FheInt72();
    execute(() -> fhe_int512_cast_into_fhe_int72(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_int80(const struct FheInt512 *sself, struct FheInt80 **result);
  ///```
  public FheInt80 castIntoFheInt80() {
    FheInt80 result = new FheInt80();
    execute(() -> fhe_int512_cast_into_fhe_int80(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int88(const struct FheInt512 *sself, struct FheInt88 **result);
  ///```
  public FheInt88 castIntoFheInt88() {
    FheInt88 result = new FheInt88();
    execute(() -> fhe_int512_cast_into_fhe_int88(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_int96(const struct FheInt512 *sself, struct FheInt96 **result);
  ///```
  public FheInt96 castIntoFheInt96() {
    FheInt96 result = new FheInt96();
    execute(() -> fhe_int512_cast_into_fhe_int96(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint104(const struct FheInt512 *sself, struct FheUint104 **result);
  /// ```
  public FheUint104 castIntoFheUint104() {
    FheUint104 result = new FheUint104();
    execute(() -> fhe_int512_cast_into_fhe_uint104(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint112(const struct FheInt512 *sself, struct FheUint112 **result);
  /// ```
  public FheUint112 castIntoFheUint112() {
    FheUint112 result = new FheUint112();
    execute(() -> fhe_int512_cast_into_fhe_uint112(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint120(const struct FheInt512 *sself, struct FheUint120 **result);
  /// ```
  public FheUint120 castIntoFheUint120() {
    FheUint120 result = new FheUint120();
    execute(() -> fhe_int512_cast_into_fhe_uint120(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint136(const struct FheInt512 *sself, struct FheUint136 **result);
  /// ```
  public FheUint136 castIntoFheUint136() {
    FheUint136 result = new FheUint136();
    execute(() -> fhe_int512_cast_into_fhe_uint136(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint144(const struct FheInt512 *sself, struct FheUint144 **result);
  /// ```
  public FheUint144 castIntoFheUint144() {
    FheUint144 result = new FheUint144();
    execute(() -> fhe_int512_cast_into_fhe_uint144(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint152(const struct FheInt512 *sself, struct FheUint152 **result);
  /// ```
  public FheUint152 castIntoFheUint152() {
    FheUint152 result = new FheUint152();
    execute(() -> fhe_int512_cast_into_fhe_uint152(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint168(const struct FheInt512 *sself, struct FheUint168 **result);
  /// ```
  public FheUint168 castIntoFheUint168() {
    FheUint168 result = new FheUint168();
    execute(() -> fhe_int512_cast_into_fhe_uint168(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint176(const struct FheInt512 *sself, struct FheUint176 **result);
  /// ```
  public FheUint176 castIntoFheUint176() {
    FheUint176 result = new FheUint176();
    execute(() -> fhe_int512_cast_into_fhe_uint176(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint184(const struct FheInt512 *sself, struct FheUint184 **result);
  /// ```
  public FheUint184 castIntoFheUint184() {
    FheUint184 result = new FheUint184();
    execute(() -> fhe_int512_cast_into_fhe_uint184(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint192(const struct FheInt512 *sself, struct FheUint192 **result);
  /// ```
  public FheUint192 castIntoFheUint192() {
    FheUint192 result = new FheUint192();
    execute(() -> fhe_int512_cast_into_fhe_uint192(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint200(const struct FheInt512 *sself, struct FheUint200 **result);
  /// ```
  public FheUint200 castIntoFheUint200() {
    FheUint200 result = new FheUint200();
    execute(() -> fhe_int512_cast_into_fhe_uint200(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint208(const struct FheInt512 *sself, struct FheUint208 **result);
///```
  public FheUint208 castIntoFheUint208() {
    FheUint208 result = new FheUint208();
    execute(() -> fhe_int512_cast_into_fhe_uint208(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint216(const struct FheInt512 *sself, struct FheUint216 **result);
///```
  public FheUint216 castIntoFheUint216() {
    FheUint216 result = new FheUint216();
    execute(() -> fhe_int512_cast_into_fhe_uint216(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint224(const struct FheInt512 *sself, struct FheUint224 **result);
///```
  public FheUint224 castIntoFheUint224() {
    FheUint224 result = new FheUint224();
    execute(() -> fhe_int512_cast_into_fhe_uint224(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint232(const struct FheInt512 *sself, struct FheUint232 **result);
///```
  public FheUint232 castIntoFheUint232() {
    FheUint232 result = new FheUint232();
    execute(() -> fhe_int512_cast_into_fhe_uint232(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint24(const struct FheInt512 *sself, struct FheUint24 **result);
  ///```
  public FheUint24 castIntoFheUint24() {
    FheUint24 result = new FheUint24();
    execute(() -> fhe_int512_cast_into_fhe_uint24(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint240(const struct FheInt512 *sself, struct FheUint240 **result);
///```
  public FheUint240 castIntoFheUint240() {
    FheUint240 result = new FheUint240();
    execute(() -> fhe_int512_cast_into_fhe_uint240(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint248(const struct FheInt512 *sself, struct FheUint248 **result);
///```
  public FheUint248 castIntoFheUint248() {
    FheUint248 result = new FheUint248();
    execute(() -> fhe_int512_cast_into_fhe_uint248(getValue(), result.getAddress()));
    return result;
  }
...
///```
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint40(const struct FheInt512 *sself, struct FheUint40 **result);
  ///```
  public FheUint40 castIntoFheUint40() {
    FheUint40 result = new FheUint40();
    execute(() -> fhe_int512_cast_into_fhe_uint40(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint48(const struct FheInt512 *sself, struct FheUint48 **result);
  ///```
  public FheUint48 castIntoFheUint48() {
    FheUint48 result = new FheUint48();
    execute(() -> fhe_int512_cast_into_fhe_uint48(getValue(), result.getAddress()));
    return result;
  }
...
///```
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint56(const struct FheInt512 *sself, struct FheUint56 **result);
  ///```
  public FheUint56 castIntoFheUint56() {
    FheUint56 result = new FheUint56();
    execute(() -> fhe_int512_cast_into_fhe_uint56(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint72(const struct FheInt512 *sself, struct FheUint72 **result);
  ///```
  public FheUint72 castIntoFheUint72() {
    FheUint72 result = new FheUint72();
    execute(() -> fhe_int512_cast_into_fhe_uint72(getValue(), result.getAddress()));
    return result;
  }
  ...
  /// ```c
  /// int fhe_int512_cast_into_fhe_uint80(const struct FheInt512 *sself, struct FheUint80 **result);
  ///```
  public FheUint80 castIntoFheUint80() {
    FheUint80 result = new FheUint80();
    execute(() -> fhe_int512_cast_into_fhe_uint80(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint88(const struct FheInt512 *sself, struct FheUint88 **result);
  ///```
  public FheUint88 castIntoFheUint88() {
    FheUint88 result = new FheUint88();
    execute(() -> fhe_int512_cast_into_fhe_uint88(getValue(), result.getAddress()));
    return result;
  }

  /// ```c
  /// int fhe_int512_cast_into_fhe_uint96(const struct FheInt512 *sself, struct FheUint96 **result);
/// ```
public FheUint96 castIntoFheUint96() {
  FheUint96 result = new FheUint96();
  execute(() -> fhe_int512_cast_into_fhe_uint96(getValue(), result.getAddress()));
  return result;
}
