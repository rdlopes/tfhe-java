...
// @formatter:off
public class CompressedFheInt176 extends NativePointer implements CompressedFheType<I256, FheInt176, CompressedFheInt176> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int176_decompress(const struct CompressedFheInt176 *sself,
  ...
  ///  */
  /// int compressed_fhe_int176_safe_serialize(const struct CompressedFheInt176 *sself,
  ...
  ///  */
  /// int compressed_fhe_int176_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt176 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int176_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int176_clone(const struct CompressedFheInt176 *sself,
  ///                                 struct CompressedFheInt176 **result);
  ///```
  @Override
