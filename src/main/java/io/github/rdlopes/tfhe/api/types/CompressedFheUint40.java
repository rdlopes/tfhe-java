...
// @formatter:off
public class CompressedFheUint40 extends NativePointer implements CompressedFheType<Long, FheUint40, CompressedFheUint40> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint40_decompress(const struct CompressedFheUint40 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint40_safe_serialize(const struct CompressedFheUint40 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint40_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheUint40 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint40_try_encrypt_with_client_key_u64(uint64_t value,
  ...
  /// ```c
  /// int compressed_fhe_uint40_clone(const struct CompressedFheUint40 *sself,
  ///                                 struct CompressedFheUint40 **result);
  ///```
  @Override
