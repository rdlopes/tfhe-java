...
// @formatter:off
public class CompressedFheInt48 extends NativePointer implements CompressedFheType<Long, FheInt48, CompressedFheInt48> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int48_decompress(const struct CompressedFheInt48 *sself,
  ...
  ///  */
  /// int compressed_fhe_int48_safe_serialize(const struct CompressedFheInt48 *sself,
  ...
  ///  */
  /// int compressed_fhe_int48_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                      uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_int48_try_encrypt_with_client_key_i64(int64_t value,
