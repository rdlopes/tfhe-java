...
// @formatter:off
public class CompressedFheUint240 extends NativePointer implements CompressedFheType<U256, FheUint240, CompressedFheUint240> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint240_decompress(const struct CompressedFheUint240 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint240_safe_serialize(const struct CompressedFheUint240 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint240_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ///                                                        const struct ServerKey *server_key,
  ///                                                        struct CompressedFheUint240 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint240_try_encrypt_with_client_key_u256(struct U256 value,
  ...
  /// ```c
  /// int compressed_fhe_uint240_clone(const struct CompressedFheUint240 *sself,
  ///                                  struct CompressedFheUint240 **result);
  ///```
  @Override
