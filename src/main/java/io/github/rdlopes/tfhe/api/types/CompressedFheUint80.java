...
// @formatter:off
public class CompressedFheUint80 extends NativePointer implements CompressedFheType<U128, FheUint80, CompressedFheUint80> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint80_decompress(const struct CompressedFheUint80 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint80_safe_serialize(const struct CompressedFheUint80 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint80_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheUint80 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint80_try_encrypt_with_client_key_u128(struct U128 value,
  ...
  /// ```c
  /// int compressed_fhe_uint80_clone(const struct CompressedFheUint80 *sself,
  ///                                 struct CompressedFheUint80 **result);
  ///```
  @Override
