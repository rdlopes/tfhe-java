...
// @formatter:off
public class CompressedFheUint112 extends NativePointer implements CompressedFheType<U128, FheUint112, CompressedFheUint112> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint112_decompress(const struct CompressedFheUint112 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint112_safe_serialize(const struct CompressedFheUint112 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint112_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ///                                                        const struct ServerKey *server_key,
  ///                                                        struct CompressedFheUint112 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint112_try_encrypt_with_client_key_u128(struct U128 value,
  ...
  /// ```c
  /// int compressed_fhe_uint112_clone(const struct CompressedFheUint112 *sself,
  ///                                  struct CompressedFheUint112 **result);
  ///```
  @Override
