...
// @formatter:off
public class CompressedFheUint216 extends NativePointer implements CompressedFheType<U256, FheUint216, CompressedFheUint216> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint216_decompress(const struct CompressedFheUint216 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint216_safe_serialize(const struct CompressedFheUint216 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint216_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_uint216_try_encrypt_with_client_key_u256(struct U256 value,
  ...
  /// ```c
  /// int compressed_fhe_uint216_clone(const struct CompressedFheUint216 *sself,
  ///                                  struct CompressedFheUint216 **result);
  ///```
  @Override
