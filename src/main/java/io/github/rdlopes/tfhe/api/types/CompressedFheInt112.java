...
// @formatter:off
public class CompressedFheInt112 extends NativePointer implements CompressedFheType<I128, FheInt112, CompressedFheInt112> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int112_decompress(const struct CompressedFheInt112 *sself,
  ...
  ///  */
  /// int compressed_fhe_int112_safe_serialize(const struct CompressedFheInt112 *sself,
  ...
  ///  */
  /// int compressed_fhe_int112_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt112 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int112_try_encrypt_with_client_key_i128(struct I128 value,
  ...
  /// ```c
  /// int compressed_fhe_int112_clone(const struct CompressedFheInt112 *sself,
  ///                                 struct CompressedFheInt112 **result);
  ///```
  @Override
