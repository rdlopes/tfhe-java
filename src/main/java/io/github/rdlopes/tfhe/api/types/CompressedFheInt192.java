...
// @formatter:off
public class CompressedFheInt192 extends NativePointer implements CompressedFheType<I256, FheInt192, CompressedFheInt192> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int192_decompress(const struct CompressedFheInt192 *sself,
  ...
  ///  */
  /// int compressed_fhe_int192_safe_serialize(const struct CompressedFheInt192 *sself,
  ...
  ///  */
  /// int compressed_fhe_int192_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt192 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int192_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int192_clone(const struct CompressedFheInt192 *sself,
  ///                                 struct CompressedFheInt192 **result);
  ///```
  @Override
