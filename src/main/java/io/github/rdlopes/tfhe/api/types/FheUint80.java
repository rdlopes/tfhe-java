...
// @formatter:off
public class FheUint80 extends NativePointer implements FheUnsignedInteger<U128, FheUint80, CompressedFheUint80> {
...
public FheUint80 clone() {
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint80, CompressedFheUint80> addWithOverflow(FheUint80 other) {
    FheUint80 result = new FheUint80();
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint80, CompressedFheUint80> subtractWithOverflow(FheUint80 other){
    FheUint80 result = new FheUint80();
    FheBool overflow = new FheBool();
  ...
  ///```
  @Override
  public CheckedResult<U128, FheUint80, CompressedFheUint80> multiplyWithOverflow(FheUint80 other) {
    FheUint80 result = new FheUint80();
    FheBool overflow = new FheBool();
  ...
  ///```
  @Override
  public DividerAndRemainder<U128, FheUint80, CompressedFheUint80> divideWithRemainder(FheUint80 other) {
  ...
  ///```
  @Override
  public DividerAndRemainder<U128, FheUint80, CompressedFheUint80> divideWithRemainderScalar(U128 other) {
    FheUint80 divider = new FheUint80();
    FheUint80 remainder = new FheUint80();
  ...
  ///  */
  /// int fhe_uint80_checked_ilog2(const struct FheUint80 *input,
  ///                              struct FheUint32 **result_1,
  ///                              struct FheBool **result_2);
  ///```
  @Override
  public CheckedResult<U128, FheUint80, CompressedFheUint80> ilog2WithCheck() {
    FheUint80 result = new FheUint80();
    FheBool check = new FheBool();
    execute(() -> fhe_uint80_checked_ilog2(getValue(), result.getAddress(), check.getAddress()));
  ...
  /// ```c
  /// int generate_oblivious_pseudo_random_fhe_uint80(struct FheUint80 **out_result,
  ///                                                 uint64_t seed_low_bytes,
  ///                                                 uint64_t seed_high_bytes);
  ///```
  @Override
  public FheUint80 random(long seedLow, long seedHigh) {
    FheUint80 result = new FheUint80();
    execute(() -> generate_oblivious_pseudo_random_fhe_uint80(result.getAddress(), seedLow, seedHigh));
    return result;

  }

  /// ```c
  /// int generate_oblivious_pseudo_random_bounded_fhe_uint80(struct FheUint80 **out_result,
  ///                                                         uint64_t seed_low_bytes,
  ///                                                         uint64_t seed_high_bytes,
  ///                                                         uint64_t random_bits_count);
  ///```
  @Override
  public FheUint80 random(long seedLow, long seedHigh, long bitsCount) {
    FheUint80 result = new FheUint80();
    execute(() -> generate_oblivious_pseudo_random_bounded_fhe_uint80(result.getAddress(), seedLow, seedHigh, bitsCount));
    return result;
