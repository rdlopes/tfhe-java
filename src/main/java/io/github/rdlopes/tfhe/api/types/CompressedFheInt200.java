...
// @formatter:off
public class CompressedFheInt200 extends NativePointer implements CompressedFheType<I256, FheInt200, CompressedFheInt200> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int200_decompress(const struct CompressedFheInt200 *sself,
  ...
  ///  */
  /// int compressed_fhe_int200_safe_serialize(const struct CompressedFheInt200 *sself,
  ...
  ///  */
  /// int compressed_fhe_int200_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt200 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int200_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int200_clone(const struct CompressedFheInt200 *sself,
  ///                                 struct CompressedFheInt200 **result);
  ///```
  @Override
