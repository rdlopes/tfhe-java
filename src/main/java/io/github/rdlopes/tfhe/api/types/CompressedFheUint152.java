...
// @formatter:off
public class CompressedFheUint152 extends NativePointer implements CompressedFheType<U256, FheUint152, CompressedFheUint152> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint152_decompress(const struct CompressedFheUint152 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint152_safe_serialize(const struct CompressedFheUint152 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint152_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ///                                                        const struct ServerKey *server_key,
  ///                                                        struct CompressedFheUint152 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint152_try_encrypt_with_client_key_u256(struct U256 value,
  ...
  /// ```c
  /// int compressed_fhe_uint152_clone(const struct CompressedFheUint152 *sself,
  ///                                  struct CompressedFheUint152 **result);
  ///```
  @Override
