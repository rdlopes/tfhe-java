...
// @formatter:off
public class CompressedFheUint104 extends NativePointer implements CompressedFheType<U128, FheUint104, CompressedFheUint104> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint104_decompress(const struct CompressedFheUint104 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint104_safe_serialize(const struct CompressedFheUint104 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint104_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ///                                                        const struct ServerKey *server_key,
  ///                                                        struct CompressedFheUint104 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint104_try_encrypt_with_client_key_u128(struct U128 value,
  ...
  /// ```c
  /// int compressed_fhe_uint104_clone(const struct CompressedFheUint104 *sself,
  ///                                  struct CompressedFheUint104 **result);
  ///```
  @Override
