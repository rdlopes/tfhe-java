...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int152_decompress(const struct CompressedFheInt152 *sself,
  ...
  ///  */
  /// int compressed_fhe_int152_safe_serialize(const struct CompressedFheInt152 *sself,
  ...
  ///  */
  /// int compressed_fhe_int152_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_int152_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int152_clone(const struct CompressedFheInt152 *sself,
///                                 struct CompressedFheInt152 **result);
/// ```
@Override
