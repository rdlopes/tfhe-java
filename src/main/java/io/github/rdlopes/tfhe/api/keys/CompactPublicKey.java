...
public class CompactPublicKey extends NativePointer implements FheKey {
  ...
  public static CompactPublicKey deserialize(DynamicBuffer dynamicBuffer) {
    ...
    execute(() -> compact_public_key_safe_deserialize(dynamicBuffer.getAddress(), MAX_SERIALIZATION_SIZE, deserialized.getAddress()));
    return deserialized;
  }
  ...
  public DynamicBuffer serialize() {
    ...
    execute(() -> compact_public_key_safe_serialize(getValue(), dynamicBuffer.getAddress(), MAX_SERIALIZATION_SIZE));
