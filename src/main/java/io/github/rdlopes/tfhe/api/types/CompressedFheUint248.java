...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint248_decompress(const struct CompressedFheUint248 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint248_safe_serialize(const struct CompressedFheUint248 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint248_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_uint248_try_encrypt_with_client_key_u256(struct U256 value,
  ...
  /// ```c
  /// int compressed_fhe_uint248_clone(const struct CompressedFheUint248 *sself,
  ///                                  struct CompressedFheUint248 **result);
  ///```
  @Override
