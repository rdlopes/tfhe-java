...
// @formatter:on
  ...
  CompressedFheInt160() {
    logger.trace("init");
    super(TfheHeader::compressed_fhe_int160_destroy);
  }
  ...
  public FheInt160 decompress() {
    FheInt160 decompressed = new FheInt160();
    execute(() -> compressed_fhe_int160_decompress(getValue(), decompressed.getAddress()));
    return decompressed;
  ...
  public static CompressedFheInt160 encrypt(I256 clearValue, ClientKey clientKey) {
    CompressedFheInt160 encrypted = new CompressedFheInt160();
    execute(() -> compressed_fhe_int160_try_encrypt_with_client_key_i256(clearValue.getAddress(), clientKey.getValue(), encrypted.getAddress()));
    return encrypted;
