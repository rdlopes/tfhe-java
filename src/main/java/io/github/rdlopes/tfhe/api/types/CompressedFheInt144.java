...
// @formatter:off
public class CompressedFheInt144 extends NativePointer implements CompressedFheType<I256, FheInt144, CompressedFheInt144> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int144_decompress(const struct CompressedFheInt144 *sself,
  ...
  ///  */
  /// int compressed_fhe_int144_safe_serialize(const struct CompressedFheInt144 *sself,
  ...
  ///  */
  /// int compressed_fhe_int144_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ///                                                       const struct ServerKey *server_key,
  ///                                                       struct CompressedFheInt144 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_int144_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int144_clone(const struct CompressedFheInt144 *sself,
  ///                                 struct CompressedFheInt144 **result);
  ///```
  @Override
