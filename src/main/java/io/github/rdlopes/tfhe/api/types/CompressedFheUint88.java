...
// @formatter:off
public class CompressedFheUint88 extends NativePointer implements CompressedFheType<U128, FheUint88, CompressedFheUint88> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint88_decompress(const struct CompressedFheUint88 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint88_safe_serialize(const struct CompressedFheUint88 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint88_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_uint88_try_encrypt_with_client_key_u128(struct U128 value,
