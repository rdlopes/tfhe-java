...
// @formatter:off
public class CompressedFheInt240 extends NativePointer implements CompressedFheType<I256, FheInt240, CompressedFheInt240> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_int240_decompress(const struct CompressedFheInt240 *sself,
  ...
  ///  */
  /// int compressed_fhe_int240_safe_serialize(const struct CompressedFheInt240 *sself,
  ...
  ///  */
  /// int compressed_fhe_int240_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                       uint64_t serialized_size_limit,
  ...
  /// ```c
  /// int compressed_fhe_int240_try_encrypt_with_client_key_i256(struct I256 value,
  ...
  /// ```c
  /// int compressed_fhe_int240_clone(const struct CompressedFheInt240 *sself,
  ///                                 struct CompressedFheInt240 **result);
  ///```
  @Override
