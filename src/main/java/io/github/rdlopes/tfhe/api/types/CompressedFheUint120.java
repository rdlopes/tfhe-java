...
// @formatter:off
public class CompressedFheUint120 extends NativePointer implements CompressedFheType<U128, FheUint120, CompressedFheUint120> {
...
// @formatter:on
  ...
  /// ```c
  /// int compressed_fhe_uint120_decompress(const struct CompressedFheUint120 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint120_safe_serialize(const struct CompressedFheUint120 *sself,
  ...
  ///  */
  /// int compressed_fhe_uint120_safe_deserialize_conformant(struct DynamicBufferView buffer_view,
  ///                                                        uint64_t serialized_size_limit,
  ///                                                        const struct ServerKey *server_key,
  ///                                                        struct CompressedFheUint120 **result);
  ///```
  ...
  /// ```c
  /// int compressed_fhe_uint120_try_encrypt_with_client_key_u128(struct U128 value,
  ...
  /// ```c
  /// int compressed_fhe_uint120_clone(const struct CompressedFheUint120 *sself,
  ///                                  struct CompressedFheUint120 **result);
  ///```
  @Override
