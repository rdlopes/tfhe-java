...
class FheUint160Test {
  ...
  void performsArithmeticOperations() {
    FheUint160 a = FheUint160.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint160 b = FheUint160.encryptWithClientKey(U256.valueOf("50"), clientKey);

    FheUint160 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("150"));

    FheUint160 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("50"));

    FheUint160 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("5000"));

    a = FheUint160.encryptWithClientKey(U256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint160 r = a.scalarAdd(U256.valueOf("7"));
