...
class FheUint184Test {
  ...
  void performsAddOperation() {
    FheUint184 a = FheUint184.encryptWithClientKey(U256.valueOf("1000"), clientKey);
    FheUint184 b = FheUint184.encryptWithClientKey(U256.valueOf("500"), clientKey);

    FheUint184 result = a.add(b);
  ...
  void performsMulOperation() {
    FheUint184 a = FheUint184.encryptWithClientKey(U256.valueOf("3"), clientKey);
    FheUint184 b = FheUint184.encryptWithClientKey(U256.valueOf("4"), clientKey);

    FheUint184 result = a.mul(b);
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheUint184 a = FheUint184.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    FheUint184 b = FheUint184.encryptWithClientKey(U256.valueOf("1000"), clientKey);

    FheUint184 result = a.and(b);
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheUint184 result = a.scalarAdd(U256.valueOf("100"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheUint184 result = a.scalarSub(U256.valueOf("100"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheUint184 a = FheUint184.encryptWithClientKey(U256.valueOf("500"), clientKey);

    FheUint184 result = a.scalarMul(U256.valueOf("2"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheUint184 original = FheUint184.encryptWithClientKey(U256.valueOf("1500"), clientKey);
