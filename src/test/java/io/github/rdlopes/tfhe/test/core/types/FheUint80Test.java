...
class FheUint80Test {
  ...
  void performsArithmeticOperations() {
    FheUint80 a = FheUint80.encryptWithClientKey(U128.valueOf("100"), clientKey);
    FheUint80 b = FheUint80.encryptWithClientKey(U128.valueOf("50"), clientKey);

    FheUint80 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("150"));

    FheUint80 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("50"));

    FheUint80 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("5000"));

    a = FheUint80.encryptWithClientKey(U128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint80 r = a.scalarAdd(U128.valueOf("7"));
