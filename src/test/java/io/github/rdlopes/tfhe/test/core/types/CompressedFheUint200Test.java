...
class CompressedFheUint200Test {
  ...
  void encryptsSerializesAndDeserializes() {
    CompressedFheUint200 compressed = CompressedFheUint200.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void clonesSuccessfully() {
    CompressedFheUint200 original = CompressedFheUint200.encryptWithClientKey(U256.valueOf("100"), clientKey);
    CompressedFheUint200 cloned = original.clone();
    FheUint200 a = original.decompress();
    FheUint200 b = cloned.decompress();
