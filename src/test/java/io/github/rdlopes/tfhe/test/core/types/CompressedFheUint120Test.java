...
class CompressedFheUint120Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheUint120 compressed = CompressedFheUint120.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheUint120 original = CompressedFheUint120.encryptWithClientKey(U128.valueOf("700"), clientKey);
  ...
  @Test
  void clones() {
    CompressedFheUint120 original = CompressedFheUint120.encryptWithClientKey(U128.valueOf("1500"), clientKey);
    ...
    FheUint120 decompressed = cloned.decompress();
    U128 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U128.valueOf("1500"));
  }

  @Test
  void roundTripFromFheUint120() {
    U128 originalValue = U128.valueOf("1500");
    FheUint120 fheuint120 = FheUint120.encryptWithClientKey(originalValue, clientKey);
    CompressedFheUint120 compressed = fheuint120.compress();
    FheUint120 decompressed = compressed.decompress();
    U128 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
