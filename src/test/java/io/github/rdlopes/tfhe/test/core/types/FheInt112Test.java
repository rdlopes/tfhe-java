...
class FheInt112Test {
  ...
  void performsArithmeticOperations() {
    FheInt112 a = FheInt112.encryptWithClientKey(I128.valueOf("100"), clientKey);
    FheInt112 b = FheInt112.encryptWithClientKey(I128.valueOf("50"), clientKey);

    FheInt112 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("150"));

    FheInt112 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("50"));

    FheInt112 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("5000"));

    a = FheInt112.encryptWithClientKey(I128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt112 r = a.scalarAdd(I128.valueOf("7"));
