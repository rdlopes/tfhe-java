...
class FheInt152Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheInt152 encrypted = FheInt152.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    I256 originalValue = I256.valueOf("1000");
    FheInt152 encrypted = FheInt152.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    I256 originalValue = I256.valueOf("1000");
    FheInt152 encrypted = FheInt152.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheInt152 a = FheInt152.encryptWithClientKey(I256.valueOf("1000"), clientKey);
    FheInt152 b = FheInt152.encryptWithClientKey(I256.valueOf("500"), clientKey);

    FheInt152 result = a.add(b);
  ...
  void performsMulOperation() {
    FheInt152 a = FheInt152.encryptWithClientKey(I256.valueOf("3"), clientKey);
    FheInt152 b = FheInt152.encryptWithClientKey(I256.valueOf("4"), clientKey);

    FheInt152 result = a.mul(b);
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheInt152 a = FheInt152.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    FheInt152 b = FheInt152.encryptWithClientKey(I256.valueOf("1000"), clientKey);

    FheInt152 result = a.and(b);
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheInt152 result = a.scalarAdd(I256.valueOf("100"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheInt152 result = a.scalarSub(I256.valueOf("100"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheInt152 a = FheInt152.encryptWithClientKey(I256.valueOf("500"), clientKey);

    FheInt152 result = a.scalarMul(I256.valueOf("2"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I256.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheInt152 original = FheInt152.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheInt152 deserialized = FheInt152.deserialize(buffer, serverKey);
  ...
  void clones() {
    ...
    FheInt152 cloned = original.clone();
