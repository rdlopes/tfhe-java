...
class FheInt152Test {
  ...
  void performsArithmeticOperations() {
    FheInt152 a = FheInt152.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt152 b = FheInt152.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt152 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt152 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt152 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt152.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt152 r = a.scalarAdd(I256.valueOf("7"));
