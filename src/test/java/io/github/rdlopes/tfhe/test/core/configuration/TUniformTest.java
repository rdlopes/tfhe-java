...
class TUniformTest {
  ...
  void zero() {
    ...
    assertThat(tUniformZero.boundLog2()).isEqualTo(0);
  }
  ...
  void negative() {
    ...
    assertThat(tUniformNegative.boundLog2()).isEqualTo(-1);
  }
  ...
  void positive() {
    ...
    assertThat(tUniformPositive.boundLog2()).isEqualTo(1);
  }
  ...
  void max() {
    ...
    assertThat(tUniformMax.boundLog2()).isEqualTo(Integer.MAX_VALUE);
  }
}
