...
class CompressedFheUint184Test {
  ...
  void encryptsSerializesAndDeserializes() {
    CompressedFheUint184 compressed = CompressedFheUint184.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void clonesSuccessfully() {
    CompressedFheUint184 original = CompressedFheUint184.encryptWithClientKey(U256.valueOf("100"), clientKey);
    CompressedFheUint184 cloned = original.clone();
    FheUint184 a = original.decompress();
    FheUint184 b = cloned.decompress();
