...
class CompressedFheUint144Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheUint144 compressed = CompressedFheUint144.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheUint144 original = CompressedFheUint144.encryptWithClientKey(U256.valueOf("700"), clientKey);
  ...
  @Test
  void clones() {
    CompressedFheUint144 original = CompressedFheUint144.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    ...
    FheUint144 decompressed = cloned.decompress();
    U256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("1500"));
  }

  @Test
  void roundTripFromFheUint144() {
    U256 originalValue = U256.valueOf("1500");
    FheUint144 fheuint144 = FheUint144.encryptWithClientKey(originalValue, clientKey);
    CompressedFheUint144 compressed = fheuint144.compress();
    FheUint144 decompressed = compressed.decompress();
    U256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
