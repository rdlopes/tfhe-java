...
class CompressedFheInt72Test {
  ...
  void encryptsSerializesAndDeserializes() {
    CompressedFheInt72 compressed = CompressedFheInt72.encryptWithClientKey(I128.valueOf("100"), clientKey);
  ...
  void clonesSuccessfully() {
    CompressedFheInt72 original = CompressedFheInt72.encryptWithClientKey(I128.valueOf("100"), clientKey);
    CompressedFheInt72 cloned = original.clone();
    FheInt72 a = original.decompress();
    FheInt72 b = cloned.decompress();
