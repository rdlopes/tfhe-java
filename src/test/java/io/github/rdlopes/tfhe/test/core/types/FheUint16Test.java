...
class FheUint16Test {
  ...
  void serializesAndDeserializes() {
    ...
    FheUint16 deserialized = FheUint16.deserialize(buffer, serverKey);
  ...
  void performsArithmeticOperations() {
    FheUint16 a = FheUint16.encryptWithClientKey((short) 100, clientKey);
    FheUint16 b = FheUint16.encryptWithClientKey((short) 50, clientKey);

    FheUint16 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo((short) 150);

    FheUint16 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo((short) 50);

    FheUint16 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo((short) 5000);

    a = FheUint16.encryptWithClientKey((short) 100, clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint16 r = a.scalarAdd((short) 7);
