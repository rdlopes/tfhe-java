...
class FheInt168Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheInt168 encrypted = FheInt168.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    ...
    I256 originalValue = I256.valueOf("100");
    FheInt168 encrypted = FheInt168.encryptWithPublicKey(originalValue, publicKey);
    I256 decrypted = encrypted.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I256.valueOf("100"));
    publicKey.destroy();
  }
  ...
  void encryptsAndDecryptsTrivial() {
    I256 originalValue = I256.valueOf("100");
    FheInt168 encrypted = FheInt168.encryptTrivial(originalValue);
  ...
  void serializesAndDeserializes() {
    ...
    FheInt168 deserialized = FheInt168.deserialize(buffer, serverKey);
  ...
  void clonesSuccessfully() {
    FheInt168 original = FheInt168.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt168 cloned = original.clone();
  ...
  void performsArithmeticOperations() {
    FheInt168 a = FheInt168.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt168 b = FheInt168.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt168 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt168 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt168 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt168.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt168 r = a.scalarAdd(I256.valueOf("7"));
