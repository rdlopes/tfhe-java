...
class FheUint10Test {
  ...
  void performsArithmeticOperations() {
    FheUint10 a = FheUint10.encryptWithClientKey((short) 100, clientKey);
    FheUint10 b = FheUint10.encryptWithClientKey((short) 50, clientKey);

    FheUint10 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo((short) 150);

    FheUint10 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo((short) 50);

    FheUint10 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo((short) 904);

    a = FheUint10.encryptWithClientKey((short) 100, clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint10 r = a.scalarAdd((short) 7);
