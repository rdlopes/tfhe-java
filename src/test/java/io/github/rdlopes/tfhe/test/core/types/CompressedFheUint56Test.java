...
class CompressedFheUint56Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheUint56 compressed = CompressedFheUint56.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheUint56 original = CompressedFheUint56.encryptWithClientKey(700000L, clientKey);
  ...
  @Test
  void clones() {
    CompressedFheUint56 original = CompressedFheUint56.encryptWithClientKey(1500000L, clientKey);
    ...
    FheUint56 decompressed = cloned.decompress();
    long decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(1500000L);
  }

  @Test
  void roundTripFromFheUint56() {
    long originalValue = 1500000L;
    FheUint56 fheuint56 = FheUint56.encryptWithClientKey(originalValue, clientKey);
    CompressedFheUint56 compressed = fheuint56.compress();
    FheUint56 decompressed = compressed.decompress();
    long decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
