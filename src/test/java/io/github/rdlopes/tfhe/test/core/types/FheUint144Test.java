...
class FheUint144Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheUint144 encrypted = FheUint144.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    ...
    U256 originalValue = U256.valueOf("100");
    FheUint144 encrypted = FheUint144.encryptWithPublicKey(originalValue, publicKey);
    U256 decrypted = encrypted.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("100"));
    publicKey.destroy();
  }
  ...
  void encryptsAndDecryptsTrivial() {
    U256 originalValue = U256.valueOf("100");
    FheUint144 encrypted = FheUint144.encryptTrivial(originalValue);
  ...
  void serializesAndDeserializes() {
    ...
    FheUint144 deserialized = FheUint144.deserialize(buffer, serverKey);
  ...
  void clonesSuccessfully() {
    FheUint144 original = FheUint144.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint144 cloned = original.clone();
  ...
  void performsArithmeticOperations() {
    FheUint144 a = FheUint144.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint144 b = FheUint144.encryptWithClientKey(U256.valueOf("50"), clientKey);

    FheUint144 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("150"));

    FheUint144 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("50"));

    FheUint144 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("5000"));

    a = FheUint144.encryptWithClientKey(U256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint144 r = a.scalarAdd(U256.valueOf("7"));
