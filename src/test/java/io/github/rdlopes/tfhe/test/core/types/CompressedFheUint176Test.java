...
class CompressedFheUint176Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheUint176 compressed = CompressedFheUint176.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheUint176 original = CompressedFheUint176.encryptWithClientKey(U256.valueOf("700"), clientKey);
  ...
  @Test
  void clones() {
    CompressedFheUint176 original = CompressedFheUint176.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    ...
    FheUint176 decompressed = cloned.decompress();
    U256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("1500"));
  }

  @Test
  void roundTripFromFheUint176() {
    U256 originalValue = U256.valueOf("1500");
    FheUint176 fheuint176 = FheUint176.encryptWithClientKey(originalValue, clientKey);
    CompressedFheUint176 compressed = fheuint176.compress();
    FheUint176 decompressed = compressed.decompress();
    U256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
