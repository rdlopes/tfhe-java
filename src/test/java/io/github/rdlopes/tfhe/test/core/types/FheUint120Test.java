...
class FheUint120Test {
  ...
  void performsArithmeticOperations() {
    FheUint120 a = FheUint120.encryptWithClientKey(U128.valueOf("100"), clientKey);
    FheUint120 b = FheUint120.encryptWithClientKey(U128.valueOf("50"), clientKey);

    FheUint120 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("150"));

    FheUint120 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("50"));

    FheUint120 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("5000"));

    a = FheUint120.encryptWithClientKey(U128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint120 r = a.scalarAdd(U128.valueOf("7"));
