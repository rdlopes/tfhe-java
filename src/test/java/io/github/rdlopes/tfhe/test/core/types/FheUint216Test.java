...
class FheUint216Test {
  ...
  void performsArithmeticOperations() {
    FheUint216 a = FheUint216.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint216 b = FheUint216.encryptWithClientKey(U256.valueOf("50"), clientKey);

    FheUint216 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("150"));

    FheUint216 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("50"));

    FheUint216 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("5000"));

    a = FheUint216.encryptWithClientKey(U256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint216 r = a.scalarAdd(U256.valueOf("7"));
