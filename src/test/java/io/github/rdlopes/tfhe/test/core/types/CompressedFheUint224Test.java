...
class CompressedFheUint224Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheUint224 compressed = CompressedFheUint224.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheUint224 original = CompressedFheUint224.encryptWithClientKey(U256.valueOf("700"), clientKey);
  ...
  @Test
  void clones() {
    CompressedFheUint224 original = CompressedFheUint224.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    ...
    FheUint224 decompressed = cloned.decompress();
    U256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("1500"));
  }

  @Test
  void roundTripFromFheUint224() {
    U256 originalValue = U256.valueOf("1500");
    FheUint224 fheuint224 = FheUint224.encryptWithClientKey(originalValue, clientKey);
    CompressedFheUint224 compressed = fheuint224.compress();
    FheUint224 decompressed = compressed.decompress();
    U256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
