...
class FheInt48Test {
  ...
  void performsArithmeticOperations() {
    FheInt48 a = FheInt48.encryptWithClientKey(100, clientKey);
    FheInt48 b = FheInt48.encryptWithClientKey(50, clientKey);

    FheInt48 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(150);

    FheInt48 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(50);

    FheInt48 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(5000);

    a = FheInt48.encryptWithClientKey(100, clientKey);
    a.addAssign(b);
