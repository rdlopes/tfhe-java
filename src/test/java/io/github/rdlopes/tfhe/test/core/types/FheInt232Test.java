...
class FheInt232Test {
  ...
  void serializesAndDeserializes() {
    FheInt232 original = FheInt232.encryptWithClientKey(I256.valueOf("100"), clientKey);
  ...
  void performsArithmeticOperations() {
    FheInt232 a = FheInt232.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt232 b = FheInt232.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt232 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt232 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt232 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt232.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt232 r = a.scalarAdd(I256.valueOf("7"));
