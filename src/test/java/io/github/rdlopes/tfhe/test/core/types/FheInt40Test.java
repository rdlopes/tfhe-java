...
class FheInt40Test {
  ...
  void performsArithmeticOperations() {
    FheInt40 a = FheInt40.encryptWithClientKey(100, clientKey);
    FheInt40 b = FheInt40.encryptWithClientKey(50, clientKey);

    FheInt40 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(150);

    FheInt40 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(50);

    FheInt40 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(5000);

    a = FheInt40.encryptWithClientKey(100, clientKey);
    a.addAssign(b);
