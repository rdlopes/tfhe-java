...
class FheInt144Test {
  ...
  void performsArithmeticOperations() {
    FheInt144 a = FheInt144.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt144 b = FheInt144.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt144 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt144 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt144 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt144.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt144 r = a.scalarAdd(I256.valueOf("7"));
