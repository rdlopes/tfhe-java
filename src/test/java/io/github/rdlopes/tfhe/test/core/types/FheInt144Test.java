...
class FheInt144Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheInt144 encrypted = FheInt144.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    I256 originalValue = I256.valueOf("1000");
    FheInt144 encrypted = FheInt144.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    I256 originalValue = I256.valueOf("1000");
    FheInt144 encrypted = FheInt144.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheInt144 a = FheInt144.encryptWithClientKey(I256.valueOf("1000"), clientKey);
    FheInt144 b = FheInt144.encryptWithClientKey(I256.valueOf("500"), clientKey);

    FheInt144 result = a.add(b);
  ...
  void performsMulOperation() {
    FheInt144 a = FheInt144.encryptWithClientKey(I256.valueOf("3"), clientKey);
    FheInt144 b = FheInt144.encryptWithClientKey(I256.valueOf("4"), clientKey);

    FheInt144 result = a.mul(b);
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheInt144 a = FheInt144.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    FheInt144 b = FheInt144.encryptWithClientKey(I256.valueOf("1000"), clientKey);

    FheInt144 result = a.and(b);
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheInt144 result = a.scalarAdd(I256.valueOf("100"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheInt144 result = a.scalarSub(I256.valueOf("100"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheInt144 a = FheInt144.encryptWithClientKey(I256.valueOf("500"), clientKey);

    FheInt144 result = a.scalarMul(I256.valueOf("2"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I256.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheInt144 original = FheInt144.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheInt144 deserialized = FheInt144.deserialize(buffer, serverKey);
  ...
  void clones() {
    ...
    FheInt144 cloned = original.clone();
