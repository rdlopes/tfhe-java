...
class CompressedFheUint232Test {
  ...
  void encryptsSerializesAndDeserializes() {
    CompressedFheUint232 compressed = CompressedFheUint232.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void decompressesRoundTrip() {
    FheUint232 original = FheUint232.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void clonesSuccessfully() {
    CompressedFheUint232 original = CompressedFheUint232.encryptWithClientKey(U256.valueOf("100"), clientKey);
    CompressedFheUint232 cloned = original.clone();
    FheUint232 a = original.decompress();
    FheUint232 b = cloned.decompress();
