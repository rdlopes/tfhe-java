...
class FheUint112Test {
  ...
  void performsArithmeticOperations() {
    FheUint112 a = FheUint112.encryptWithClientKey(U128.valueOf("100"), clientKey);
    FheUint112 b = FheUint112.encryptWithClientKey(U128.valueOf("50"), clientKey);

    FheUint112 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("150"));

    FheUint112 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("50"));

    FheUint112 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("5000"));

    a = FheUint112.encryptWithClientKey(U128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint112 r = a.scalarAdd(U128.valueOf("7"));
