...
class FheUint128Test {
  ...
  void performsArithmeticOperations() {
    FheUint128 a = FheUint128.encryptWithClientKey(U128.valueOf("100"), clientKey);
    FheUint128 b = FheUint128.encryptWithClientKey(U128.valueOf("50"), clientKey);

    FheUint128 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("150"));

    FheUint128 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("50"));

    FheUint128 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("5000"));

    a = FheUint128.encryptWithClientKey(U128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint128 r = a.scalarAdd(U128.valueOf("7"));
