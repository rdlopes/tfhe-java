...
class FheUint128Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheUint128 encrypted = FheUint128.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    U128 originalValue = U128.valueOf("1000");
    FheUint128 encrypted = FheUint128.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    U128 originalValue = U128.valueOf("1000");
    FheUint128 encrypted = FheUint128.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheUint128 a = FheUint128.encryptWithClientKey(U128.valueOf("1000"), clientKey);
    FheUint128 b = FheUint128.encryptWithClientKey(U128.valueOf("500"), clientKey);

    FheUint128 result = a.add(b);
  ...
  void performsMulOperation() {
    FheUint128 a = FheUint128.encryptWithClientKey(U128.valueOf("3"), clientKey);
    FheUint128 b = FheUint128.encryptWithClientKey(U128.valueOf("4"), clientKey);

    FheUint128 result = a.mul(b);
    U128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheUint128 a = FheUint128.encryptWithClientKey(U128.valueOf("1500"), clientKey);
    FheUint128 b = FheUint128.encryptWithClientKey(U128.valueOf("1000"), clientKey);

    FheUint128 result = a.and(b);
    U128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheUint128 result = a.scalarAdd(U128.valueOf("100"));
    U128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheUint128 result = a.scalarSub(U128.valueOf("100"));
    U128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheUint128 a = FheUint128.encryptWithClientKey(U128.valueOf("500"), clientKey);

    FheUint128 result = a.scalarMul(U128.valueOf("2"));
    U128 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U128.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheUint128 original = FheUint128.encryptWithClientKey(U128.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheUint128 deserialized = FheUint128.deserialize(buffer, serverKey);
  ...
  void clones() {
    ...
    FheUint128 cloned = original.clone();
