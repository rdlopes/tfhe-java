...
class CompressedFheUint104Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheUint104 compressed = CompressedFheUint104.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheUint104 original = CompressedFheUint104.encryptWithClientKey(U128.valueOf("700"), clientKey);
  ...
  @Test
  void clones() {
    CompressedFheUint104 original = CompressedFheUint104.encryptWithClientKey(U128.valueOf("1500"), clientKey);
    ...
    FheUint104 decompressed = cloned.decompress();
    U128 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U128.valueOf("1500"));
  }

  @Test
  void roundTripFromFheUint104() {
    U128 originalValue = U128.valueOf("1500");
    FheUint104 fheuint104 = FheUint104.encryptWithClientKey(originalValue, clientKey);
    CompressedFheUint104 compressed = fheuint104.compress();
    FheUint104 decompressed = compressed.decompress();
    U128 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
