...
class FheInt256Test {
  ...
  void performsArithmeticOperations() {
    FheInt256 a = FheInt256.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt256 b = FheInt256.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt256 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt256 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt256 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt256.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt256 r = a.scalarAdd(I256.valueOf("7"));
