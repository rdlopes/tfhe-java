...
class CompressedFheUint240Test {
  ...
  void encryptsSerializesAndDeserializes() {
    CompressedFheUint240 compressed = CompressedFheUint240.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void clonesSuccessfully() {
    CompressedFheUint240 original = CompressedFheUint240.encryptWithClientKey(U256.valueOf("100"), clientKey);
    CompressedFheUint240 cloned = original.clone();
    FheUint240 a = original.decompress();
    FheUint240 b = cloned.decompress();
