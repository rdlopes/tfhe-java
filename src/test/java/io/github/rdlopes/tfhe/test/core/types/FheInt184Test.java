...
class FheInt184Test {
  ...
  void serializesAndDeserializes() {
    FheInt184 original = FheInt184.encryptWithClientKey(I256.valueOf("100"), clientKey);
  ...
  void performsArithmeticOperations() {
    FheInt184 a = FheInt184.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt184 b = FheInt184.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt184 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt184 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt184 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt184.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt184 r = a.scalarAdd(I256.valueOf("7"));
