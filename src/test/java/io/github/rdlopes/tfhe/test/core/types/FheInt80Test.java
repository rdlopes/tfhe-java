...
class FheInt80Test {
  ...
  void performsArithmeticOperations() {
    FheInt80 a = FheInt80.encryptWithClientKey(I128.valueOf("100"), clientKey);
    FheInt80 b = FheInt80.encryptWithClientKey(I128.valueOf("50"), clientKey);

    FheInt80 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("150"));

    FheInt80 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("50"));

    FheInt80 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("5000"));

    a = FheInt80.encryptWithClientKey(I128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt80 r = a.scalarAdd(I128.valueOf("7"));
