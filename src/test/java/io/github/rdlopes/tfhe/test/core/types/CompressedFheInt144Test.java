...
class CompressedFheInt144Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheInt144 compressed = CompressedFheInt144.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheInt144 original = CompressedFheInt144.encryptWithClientKey(I256.valueOf("700"), clientKey);
  ...
  @Test
  void clones() {
    CompressedFheInt144 original = CompressedFheInt144.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    ...
    FheInt144 decompressed = cloned.decompress();
    I256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I256.valueOf("1500"));
  }

  @Test
  void roundTripFromFheInt144() {
    I256 originalValue = I256.valueOf("1500");
    FheInt144 fheint144 = FheInt144.encryptWithClientKey(originalValue, clientKey);
    CompressedFheInt144 compressed = fheint144.compress();
    FheInt144 decompressed = compressed.decompress();
    I256 decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
