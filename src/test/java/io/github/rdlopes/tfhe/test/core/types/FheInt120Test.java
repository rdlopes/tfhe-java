...
class FheInt120Test {
  ...
  void performsArithmeticOperations() {
    FheInt120 a = FheInt120.encryptWithClientKey(I128.valueOf("100"), clientKey);
    FheInt120 b = FheInt120.encryptWithClientKey(I128.valueOf("50"), clientKey);

    FheInt120 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("150"));

    FheInt120 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("50"));

    FheInt120 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("5000"));

    a = FheInt120.encryptWithClientKey(I128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt120 r = a.scalarAdd(I128.valueOf("7"));
