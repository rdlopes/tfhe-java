...
class CompressedFheInt12Test {
  ...
  void encryptsWithClientKey() {
    ...
    CompressedFheInt12 compressed = CompressedFheInt12.encryptWithClientKey(originalValue, clientKey);
  ...
  void serializesAndDeserializes() {
    CompressedFheInt12 original = CompressedFheInt12.encryptWithClientKey((short) 700, clientKey);
  ...
  @Test
  void clones() {
    CompressedFheInt12 original = CompressedFheInt12.encryptWithClientKey((short) 1500, clientKey);
    ...
    FheInt12 decompressed = cloned.decompress();
    short decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo((short) 1500);
  }

  @Test
  void roundTripFromFheInt12() {
    short originalValue = (short) 1500;
    FheInt12 fheint12 = FheInt12.encryptWithClientKey(originalValue, clientKey);
    CompressedFheInt12 compressed = fheint12.compress();
    FheInt12 decompressed = compressed.decompress();
    short decrypted = decompressed.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(originalValue);
  }
