...
class FheUint224Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheUint224 encrypted = FheUint224.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    U256 originalValue = U256.valueOf("1000");
    FheUint224 encrypted = FheUint224.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    U256 originalValue = U256.valueOf("1000");
    FheUint224 encrypted = FheUint224.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheUint224 a = FheUint224.encryptWithClientKey(U256.valueOf("1000"), clientKey);
    FheUint224 b = FheUint224.encryptWithClientKey(U256.valueOf("500"), clientKey);

    FheUint224 result = a.add(b);
  ...
  void performsMulOperation() {
    FheUint224 a = FheUint224.encryptWithClientKey(U256.valueOf("3"), clientKey);
    FheUint224 b = FheUint224.encryptWithClientKey(U256.valueOf("4"), clientKey);

    FheUint224 result = a.mul(b);
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheUint224 a = FheUint224.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    FheUint224 b = FheUint224.encryptWithClientKey(U256.valueOf("1000"), clientKey);

    FheUint224 result = a.and(b);
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheUint224 result = a.scalarAdd(U256.valueOf("100"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheUint224 result = a.scalarSub(U256.valueOf("100"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheUint224 a = FheUint224.encryptWithClientKey(U256.valueOf("500"), clientKey);

    FheUint224 result = a.scalarMul(U256.valueOf("2"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheUint224 original = FheUint224.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheUint224 deserialized = FheUint224.deserialize(buffer, serverKey);
  ...
  void clones() {
    ...
    FheUint224 cloned = original.clone();
