...
class FheUint224Test {
  ...
  void performsArithmeticOperations() {
    FheUint224 a = FheUint224.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint224 b = FheUint224.encryptWithClientKey(U256.valueOf("50"), clientKey);

    FheUint224 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("150"));

    FheUint224 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("50"));

    FheUint224 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("5000"));

    a = FheUint224.encryptWithClientKey(U256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint224 r = a.scalarAdd(U256.valueOf("7"));
