...
class FheInt248Test {
  ...
  void serializesAndDeserializes() {
    FheInt248 original = FheInt248.encryptWithClientKey(I256.valueOf("100"), clientKey);
  ...
  void performsArithmeticOperations() {
    FheInt248 a = FheInt248.encryptWithClientKey(I256.valueOf("100"), clientKey);
    FheInt248 b = FheInt248.encryptWithClientKey(I256.valueOf("50"), clientKey);

    FheInt248 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("150"));

    FheInt248 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("50"));

    FheInt248 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I256.valueOf("5000"));

    a = FheInt248.encryptWithClientKey(I256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt248 r = a.scalarAdd(I256.valueOf("7"));
