...
class FheInt248Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheInt248 encrypted = FheInt248.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    I256 originalValue = I256.valueOf("1000");
    FheInt248 encrypted = FheInt248.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    I256 originalValue = I256.valueOf("1000");
    FheInt248 encrypted = FheInt248.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheInt248 a = FheInt248.encryptWithClientKey(I256.valueOf("1000"), clientKey);
    FheInt248 b = FheInt248.encryptWithClientKey(I256.valueOf("500"), clientKey);

    FheInt248 result = a.add(b);
  ...
  void performsMulOperation() {
    FheInt248 a = FheInt248.encryptWithClientKey(I256.valueOf("3"), clientKey);
    FheInt248 b = FheInt248.encryptWithClientKey(I256.valueOf("4"), clientKey);

    FheInt248 result = a.mul(b);
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheInt248 a = FheInt248.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    FheInt248 b = FheInt248.encryptWithClientKey(I256.valueOf("1000"), clientKey);

    FheInt248 result = a.and(b);
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheInt248 result = a.scalarAdd(I256.valueOf("100"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheInt248 result = a.scalarSub(I256.valueOf("100"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheInt248 a = FheInt248.encryptWithClientKey(I256.valueOf("500"), clientKey);

    FheInt248 result = a.scalarMul(I256.valueOf("2"));
    I256 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I256.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheInt248 original = FheInt248.encryptWithClientKey(I256.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheInt248 deserialized = FheInt248.deserialize(buffer, serverKey);
  ...
  void compressesAndDecompresses() {
    ...
    CompressedFheInt248 compressed = original.compress();
  ...
  void clones() {
    ...
    FheInt248 cloned = original.clone();
