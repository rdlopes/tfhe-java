...
class CompressedFheUint248Test {
  ...
  void encryptsSerializesAndDeserializes() {
    CompressedFheUint248 compressed = CompressedFheUint248.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void clonesSuccessfully() {
    CompressedFheUint248 original = CompressedFheUint248.encryptWithClientKey(U256.valueOf("100"), clientKey);
    CompressedFheUint248 cloned = original.clone();
    FheUint248 a = original.decompress();
    FheUint248 b = cloned.decompress();
