...
import io.github.rdlopes.tfhe.core.types.CompressedFheUint208;
import io.github.rdlopes.tfhe.core.types.FheBool;
import io.github.rdlopes.tfhe.core.types.FheUint208;
...
class FheUint208Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheUint208 encrypted = FheUint208.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    ...
    U256 originalValue = U256.valueOf("100");
    FheUint208 encrypted = FheUint208.encryptWithPublicKey(originalValue, publicKey);
    U256 decrypted = encrypted.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("100"));
    publicKey.destroy();
  }
  ...
  void encryptsAndDecryptsTrivial() {
    U256 originalValue = U256.valueOf("100");
    FheUint208 encrypted = FheUint208.encryptTrivial(originalValue);
  ...
  void serializesAndDeserializes() {
    FheUint208 original = FheUint208.encryptWithClientKey(U256.valueOf("100"), clientKey);
    DynamicBufferView buffer = original.serialize();
    FheUint208 deserialized = FheUint208.deserialize(buffer, serverKey);
  ...
  void compressesAndDecompresses() {
    FheUint208 original = FheUint208.encryptWithClientKey(U256.valueOf("100"), clientKey);
    CompressedFheUint208 compressed = original.compress();
    FheUint208 decompressed = compressed.decompress();
  ...
  void clonesSuccessfully() {
    FheUint208 original = FheUint208.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint208 cloned = original.clone();
  ...
  void performsArithmeticOperations() {
    FheUint208 a = FheUint208.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint208 b = FheUint208.encryptWithClientKey(U256.valueOf("50"), clientKey);

    FheUint208 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("150"));

    FheUint208 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("50"));

    FheUint208 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("5000"));

    a = FheUint208.encryptWithClientKey(U256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint208 r = a.scalarAdd(U256.valueOf("7"));
