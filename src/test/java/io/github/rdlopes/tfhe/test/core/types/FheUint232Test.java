...
class FheUint232Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheUint232 encrypted = FheUint232.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    U256 originalValue = U256.valueOf("1000");
    FheUint232 encrypted = FheUint232.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    U256 originalValue = U256.valueOf("1000");
    FheUint232 encrypted = FheUint232.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheUint232 a = FheUint232.encryptWithClientKey(U256.valueOf("1000"), clientKey);
    FheUint232 b = FheUint232.encryptWithClientKey(U256.valueOf("500"), clientKey);

    FheUint232 result = a.add(b);
  ...
  void performsMulOperation() {
    FheUint232 a = FheUint232.encryptWithClientKey(U256.valueOf("3"), clientKey);
    FheUint232 b = FheUint232.encryptWithClientKey(U256.valueOf("4"), clientKey);

    FheUint232 result = a.mul(b);
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheUint232 a = FheUint232.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    FheUint232 b = FheUint232.encryptWithClientKey(U256.valueOf("1000"), clientKey);

    FheUint232 result = a.and(b);
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheUint232 result = a.scalarAdd(U256.valueOf("100"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheUint232 result = a.scalarSub(U256.valueOf("100"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheUint232 a = FheUint232.encryptWithClientKey(U256.valueOf("500"), clientKey);

    FheUint232 result = a.scalarMul(U256.valueOf("2"));
    U256 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(U256.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheUint232 original = FheUint232.encryptWithClientKey(U256.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheUint232 deserialized = FheUint232.deserialize(buffer, serverKey);
  ...
  void compressesAndDecompresses() {
    ...
    CompressedFheUint232 compressed = original.compress();
  ...
  void clones() {
    ...
    FheUint232 cloned = original.clone();
