...
class FheUint240Test {
  ...
  void serializesAndDeserializes() {
    FheUint240 original = FheUint240.encryptWithClientKey(U256.valueOf("100"), clientKey);
  ...
  void performsArithmeticOperations() {
    FheUint240 a = FheUint240.encryptWithClientKey(U256.valueOf("100"), clientKey);
    FheUint240 b = FheUint240.encryptWithClientKey(U256.valueOf("50"), clientKey);

    FheUint240 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("150"));

    FheUint240 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("50"));

    FheUint240 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U256.valueOf("5000"));

    a = FheUint240.encryptWithClientKey(U256.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint240 r = a.scalarAdd(U256.valueOf("7"));
