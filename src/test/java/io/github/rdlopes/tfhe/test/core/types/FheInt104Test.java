...
class FheInt104Test {
  ...
  void performsArithmeticOperations() {
    FheInt104 a = FheInt104.encryptWithClientKey(I128.valueOf("100"), clientKey);
    FheInt104 b = FheInt104.encryptWithClientKey(I128.valueOf("50"), clientKey);

    FheInt104 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("150"));

    FheInt104 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("50"));

    FheInt104 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(I128.valueOf("5000"));

    a = FheInt104.encryptWithClientKey(I128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheInt104 r = a.scalarAdd(I128.valueOf("7"));
