...
class FheInt104Test {
  ...
  void encryptsAndDecryptsWithClientKey() {
    ...
    FheInt104 encrypted = FheInt104.encryptWithClientKey(originalValue, clientKey);
  ...
  void encryptsAndDecryptsWithPublicKey() {
    I128 originalValue = I128.valueOf("1000");
    FheInt104 encrypted = FheInt104.encryptWithPublicKey(originalValue, publicKey);
  ...
  void encryptsAndDecryptsTrivial() {
    I128 originalValue = I128.valueOf("1000");
    FheInt104 encrypted = FheInt104.encryptTrivial(originalValue);
  ...
  void performsAddOperation() {
    FheInt104 a = FheInt104.encryptWithClientKey(I128.valueOf("1000"), clientKey);
    FheInt104 b = FheInt104.encryptWithClientKey(I128.valueOf("500"), clientKey);

    FheInt104 result = a.add(b);
  ...
  void performsMulOperation() {
    FheInt104 a = FheInt104.encryptWithClientKey(I128.valueOf("3"), clientKey);
    FheInt104 b = FheInt104.encryptWithClientKey(I128.valueOf("4"), clientKey);

    FheInt104 result = a.mul(b);
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheInt104 a = FheInt104.encryptWithClientKey(I128.valueOf("1500"), clientKey);
    FheInt104 b = FheInt104.encryptWithClientKey(I128.valueOf("1000"), clientKey);

    FheInt104 result = a.and(b);
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheInt104 result = a.scalarAdd(I128.valueOf("100"));
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheInt104 result = a.scalarSub(I128.valueOf("100"));
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheInt104 a = FheInt104.encryptWithClientKey(I128.valueOf("500"), clientKey);

    FheInt104 result = a.scalarMul(I128.valueOf("2"));
    I128 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I128.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheInt104 original = FheInt104.encryptWithClientKey(I128.valueOf("1500"), clientKey);
    DynamicBufferView buffer = original.serialize();

    assertThat(buffer.getLength()).isGreaterThan(0);

    FheInt104 deserialized = FheInt104.deserialize(buffer, serverKey);
  ...
  void clones() {
    ...
    FheInt104 cloned = original.clone();
