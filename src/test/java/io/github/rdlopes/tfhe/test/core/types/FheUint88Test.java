...
class FheUint88Test {
  ...
  void performsArithmeticOperations() {
    FheUint88 a = FheUint88.encryptWithClientKey(U128.valueOf("100"), clientKey);
    FheUint88 b = FheUint88.encryptWithClientKey(U128.valueOf("50"), clientKey);

    FheUint88 addResult = a.add(b);
    assertThat(addResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("150"));

    FheUint88 subResult = a.sub(b);
    assertThat(subResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("50"));

    FheUint88 mulResult = a.mul(b);
    assertThat(mulResult.decryptWithClientKey(clientKey)).isEqualTo(U128.valueOf("5000"));

    a = FheUint88.encryptWithClientKey(U128.valueOf("100"), clientKey);
    a.addAssign(b);
  ...
  void performsScalarAddOperations() {
    ...
    FheUint88 r = a.scalarAdd(U128.valueOf("7"));
