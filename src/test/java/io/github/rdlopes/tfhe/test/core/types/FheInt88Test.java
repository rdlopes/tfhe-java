...
class FheInt88Test {
  ...
  void performsAddOperation() {
    FheInt88 a = FheInt88.encryptWithClientKey(I128.valueOf("1000"), clientKey);
    FheInt88 b = FheInt88.encryptWithClientKey(I128.valueOf("500"), clientKey);

    FheInt88 result = a.add(b);
  ...
  void performsMulOperation() {
    FheInt88 a = FheInt88.encryptWithClientKey(I128.valueOf("3"), clientKey);
    FheInt88 b = FheInt88.encryptWithClientKey(I128.valueOf("4"), clientKey);

    FheInt88 result = a.mul(b);
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsAndOperation() {
    FheInt88 a = FheInt88.encryptWithClientKey(I128.valueOf("1500"), clientKey);
    FheInt88 b = FheInt88.encryptWithClientKey(I128.valueOf("1000"), clientKey);

    FheInt88 result = a.and(b);
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarAddOperation() {
    ...
    FheInt88 result = a.scalarAdd(I128.valueOf("100"));
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarSubOperation() {
    ...
    FheInt88 result = a.scalarSub(I128.valueOf("100"));
    I128 decrypted = result.decryptWithClientKey(clientKey);
  ...
  void performsScalarMulOperation() {
    FheInt88 a = FheInt88.encryptWithClientKey(I128.valueOf("500"), clientKey);

    FheInt88 result = a.scalarMul(I128.valueOf("2"));
    I128 decrypted = result.decryptWithClientKey(clientKey);
    assertThat(decrypted).isEqualTo(I128.valueOf("1000"));
  }
  ...
  void serializesAndDeserializes() {
    FheInt88 original = FheInt88.encryptWithClientKey(I128.valueOf("1500"), clientKey);
