...
public final class I256 extends AbstractValue {
  ...
  private I256(BigInteger value) {
    super(io.github.rdlopes.tfhe.core.ffm.I256::allocate, BIT_SIZE, true, MIN_VALUE, MAX_VALUE, value);
  }
  ...
  protected void setWord(int index, long word) {
    switch (index) {
      case 0 -> io.github.rdlopes.tfhe.core.ffm.I256.w0(getAddress(), word);
      case 1 -> io.github.rdlopes.tfhe.core.ffm.I256.w1(getAddress(), word);
      case 2 -> io.github.rdlopes.tfhe.core.ffm.I256.w2(getAddress(), word);
      case 3 -> io.github.rdlopes.tfhe.core.ffm.I256.w3(getAddress(), word);
  ...
  protected long getWord(int index) {
    return switch (index) {
      case 0 -> io.github.rdlopes.tfhe.core.ffm.I256.w0(getAddress());
      case 1 -> io.github.rdlopes.tfhe.core.ffm.I256.w1(getAddress());
      case 2 -> io.github.rdlopes.tfhe.core.ffm.I256.w2(getAddress());
      case 3 -> io.github.rdlopes.tfhe.core.ffm.I256.w3(getAddress());
      default -> throw new IndexOutOfBoundsException("Index must be 0 to 3");
    };
  }
}
