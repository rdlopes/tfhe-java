...
public final class I128 extends AbstractValue {
  ...
  private I128(BigInteger value) {
    super(io.github.rdlopes.tfhe.core.ffm.I128::allocate, BIT_SIZE, true, MIN_VALUE, MAX_VALUE, value);
  }
  ...
  protected void setWord(int index, long word) {
    switch (index) {
      case 0 -> io.github.rdlopes.tfhe.core.ffm.I128.w0(getAddress(), word);
      case 1 -> io.github.rdlopes.tfhe.core.ffm.I128.w1(getAddress(), word);
  ...
  protected long getWord(int index) {
    return switch (index) {
      case 0 -> io.github.rdlopes.tfhe.core.ffm.I128.w0(getAddress());
      case 1 -> io.github.rdlopes.tfhe.core.ffm.I128.w1(getAddress());
      default -> throw new IndexOutOfBoundsException("Index must be 0 or 1");
    };
  }
}
