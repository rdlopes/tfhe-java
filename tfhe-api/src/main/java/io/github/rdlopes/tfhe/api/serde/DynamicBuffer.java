...
import io.github.rdlopes.tfhe.core.ffm.NativeAddress;
...
public class DynamicBuffer extends NativeAddress implements AutoCloseable {
  ...
  public DynamicBuffer() {
    this(io.github.rdlopes.tfhe.core.ffm.DynamicBuffer::allocate, true);
  }
  ...
  private static Function<SegmentAllocator, MemorySegment> fromBytes(byte[] bytes) {
    return allocator -> {
      ...
      pointer.asByteBuffer()
             .put(bytes);
      MemorySegment newSegment = io.github.rdlopes.tfhe.core.ffm.DynamicBuffer.allocate(allocator);
      io.github.rdlopes.tfhe.core.ffm.DynamicBuffer.pointer(newSegment, pointer);
      io.github.rdlopes.tfhe.core.ffm.DynamicBuffer.length(newSegment, length);
      return newSegment;
    };
  }
  ...
  public Long getLength() {
    return io.github.rdlopes.tfhe.core.ffm.DynamicBuffer.length(getAddress());
  }
  ...
  public byte[] toByteArray() {
    ...
    io.github.rdlopes.tfhe.core.ffm.DynamicBuffer.pointer(getAddress())
