...
import static io.github.rdlopes.tfhe.core.ffm.TfheHeader.fhe_int10_sum;
...
public final class FheInt10Array extends NativeArray implements FheArray<FheInt10, FheInt10Array> {
  ...
  public FheBool containsArray(FheInt10Array other) {
    ...
    try (FheUint10Array lhsArr = new FheUint10Array(lhsU);
         FheUint10Array rhsArr = new FheUint10Array(rhsU)) {
