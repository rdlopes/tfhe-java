...
public final class U1024 extends AbstractValue {
  ...
  private U1024(BigInteger value) {
    super(io.github.rdlopes.tfhe.core.ffm.U1024::allocate, BIT_SIZE, false, MIN_VALUE, MAX_VALUE, value);
  }
  ...
  protected void setWord(int index, long word) {
    io.github.rdlopes.tfhe.core.ffm.U1024.words(getAddress(), index, word);
  }

  @Override
  protected long getWord(int index) {
    return io.github.rdlopes.tfhe.core.ffm.U1024.words(getAddress(), index);
  }
}
