...
public final class U2048 extends AbstractValue {
  ...
  private U2048(BigInteger value) {
    super(io.github.rdlopes.tfhe.core.ffm.U2048::allocate, BIT_SIZE, false, MIN_VALUE, MAX_VALUE, value);
  }
  ...
  protected void setWord(int index, long word) {
    io.github.rdlopes.tfhe.core.ffm.U2048.words(getAddress(), index, word);
  }

  @Override
  protected long getWord(int index) {
    return io.github.rdlopes.tfhe.core.ffm.U2048.words(getAddress(), index);
  }
}
